-- M2 — the exploded rendering on DataFusion, Q2-Q5 in the JOIN formulation.
--
-- m1-exploded.datafusion.sql reassembles a document with GROUP BY doc and
...
-- measured from m1-exploded.datafusion.sql.
