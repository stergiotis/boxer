...
- **Boxer reuse.** [`passes.WriteSettings`](../../../boxer/public/db/clickhouse/dsl/nanopass/passes/nanopass_passes_manipulate_setting.go) + [`ExecuteArrowStream`](../../src/go/public/boxerstaging/spinnaker/hmi/play/play_client.go) cover the round-trip; no new SQL-construction code in the demo beyond template strings.
...
- [`doc/adr/0001-clickhouse-observability-pipeline.md`](./0001-clickhouse-observability-pipeline.md), [`0002-query-categorization-provenance.md`](./0002-query-categorization-provenance.md), [`0003-imzero2-unified-color-type.md`](./0003-imzero2-unified-color-type.md), [`0004-retire-alpha-cbor-for-jsonv2.md`](./0004-retire-alpha-cbor-for-jsonv2.md) — prior ADRs; template shape followed here.
...
- [`src/go/public/boxerstaging/spinnaker/hmi/play/play_client.go`](../../src/go/public/boxerstaging/spinnaker/hmi/play/play_client.go) — the HTTP-based `ExecuteArrowStream` retained for other demos (case 5); not used by the regex explorer.
- [`src/go/public/thestack/imzero2/egui2/demo/apps/hn_explorer/hn_explorer.go`](../../src/go/public/thestack/imzero2/egui2/demo/apps/hn_explorer/hn_explorer.go) — structural template the new demo follows.
- [`src/go/public/thestack/imzero2/egui2/demo/apps/widgets/egui2_hl_sql_demo.go`](../../src/go/public/thestack/imzero2/egui2/demo/apps/widgets/egui2_hl_sql_demo.go) — prior art for `{name:Type}` placeholder SQL display.
