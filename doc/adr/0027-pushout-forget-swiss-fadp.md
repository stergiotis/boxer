...
| **Identifiability test** | *Relative approach* (BGE 136 II 508): effort + interest test. Identifiability fails when "the effort is so great that, according to general life experience, it cannot be expected that any interested party would undertake it." | "All means reasonably likely to be used" (Recital 26); historically read as near-absolute in EDPB practice, but CJEU *EDPS v SRB* (C-413/23 P, 4 September 2025) endorsed a recipient-perspective relative approach. | Under nLPD, the residual commitment after nonce destruction (ADR-0025 SD6) is non-personal-data on the BGE 136 II 508 effort test. Under GDPR, the EDPB 02/2025 ¶52 conditional standard still governs the controller side (ADR-0025 OQ1), but post-*SRB* the regimes converge for recipients — the gap this row originally recorded has narrowed. |
...
- [CJEU, *EDPS v SRB*, C-413/23 P, judgment of 4 September 2025 (EUR-Lex CELEX 62023CJ0413)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=celex:62023CJ0413) — EU-level endorsement of the relative approach; narrows the identifiability-test gap recorded in the comparison table.
