...
generated-at: 2026-09-20T09:05:53Z
---
...
157 variables across 15 categories, declared per ADR-0009. Re-run `go generate ./public/config/env/...` after adding or modifying specs.
...
| Name | Type | Default | CLI flag | Sensitive | Description |
|------|------|---------|----------|-----------|-------------|
| `BOXER_MDEDIT_LLM_APIKEY` | string | — | — | yes | API key sent to the transformation endpoint; empty for local endpoints that take none |
| `BOXER_MDEDIT_LLM_ENDPOINT` | string | — | — |  | OpenAI-compatible chat-completions base URL for mdedit's text transformations (e.g. http://localhost:1234/v1); unset hides the transform surface entirely |
| `BOXER_MDEDIT_LLM_MAXTOKENS` | int64 | `4096` | — |  | completion token ceiling per transformation run; a prompt doc's own max-tokens frontmatter wins |
| `BOXER_MDEDIT_LLM_MODEL` | string | — | — |  | model id for mdedit's text transformations; unset hides the transform surface even with the endpoint set |
| `BOXER_MDEDIT_LLM_TIMEOUT` | duration | `120s` | — |  | wall-clock bound on one transformation run; the client has no timeout of its own |
...
| `BOXER_PLAY_FOCUS_COMPLETION` | string | — | — |  | non-empty makes Completion the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_DETAIL` | string | — | — |  | non-empty makes Detail the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_DIAGNOSTICS` | string | — | — |  | non-empty makes Diagnostics the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_DIST` | string | — | — |  | non-empty makes Distribution the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_DOCS` | string | — | — |  | non-empty makes Docs the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_EDITOR` | string | — | — |  | non-empty makes Editor the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_EXPERIMENTS` | string | — | — |  | non-empty makes Experiments the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_FILES` | string | — | — |  | non-empty makes Files the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_FLOW` | string | — | — |  | non-empty makes Flow the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_GLOSSES` | string | — | — |  | non-empty makes Glosses the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_GRAPH` | string | — | — |  | non-empty makes Graph the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_GRAPHVIEW` | string | — | — |  | non-empty makes Graphview the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_HISTORY` | string | — | — |  | non-empty makes History the default-active tab in its dock leaf (scripted screenshots) |
...
| `BOXER_PLAY_FOCUS_PROJECTION` | string | — | — |  | non-empty makes Projection the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_SANKEY` | string | — | — |  | non-empty makes Sankey the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_SCHEMA` | string | — | — |  | non-empty makes Schema the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_SERIES` | string | — | — |  | non-empty makes Series the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_SNIPPETS` | string | — | — |  | non-empty makes Snippets the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_TABLE` | string | — | — |  | non-empty makes Table the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_TIMELINE` | string | — | — |  | non-empty makes Timeline the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_TREEMAP` | string | — | — |  | non-empty makes Treemap the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_VECTORFIELD` | string | — | — |  | non-empty makes Vector field the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_VOCABULARY` | string | — | — |  | non-empty makes Vocabulary the default-active tab in its dock leaf (scripted screenshots) |
| `BOXER_PLAY_FOCUS_WORLD` | string | — | — |  | non-empty makes World the default-active tab in its dock leaf (scripted screenshots) |
...
| `BOXER_PLAY_WINDOW_SIZE` | string | — | — |  | open the play window at "WxH" logical points (scripted screenshots); empty or unparseable keeps the host's archetype default |
...
| `IMZERO2_HEADLESS_RASTER_STATS` | bool | — | — |  | log a per-frame raster-cost percentile summary (tessellate + frame into host memory) when the headless host exits; comparable across the wgpu and CPU pixel hosts |
| `IMZERO2_HEADLESS_RASTER_THREADS` | int64 | `0` | — |  | CPU rasterizer worker threads in the headless_soft build; 0 = half the hardware threads (where the measured curve peaks) |
...
| `SCCMAP_REPO` | path | — | — |  | initial repository path explored by the Repo code exploration app; empty scans the host's worktree |
...
| `BOXER_LOG_FACTS` | string | — | — |  | non-empty (and not "0") enables the ClickHouse-backed facts store for the logbridge sink; empty/0 selects the in-memory fallback |
| `BOXER_LOG_FACTS_URL` | string | — | — |  | overrides the chstore default ClickHouse URL when BOXER_LOG_FACTS is enabled |
...
| `KEELSON_WATCHBILL_ABANDON_AFTER` | duration | `90s` | — |  | watchbill worker: a running job whose worker run has no heartbeat this recent is abandoned and re-queued |
...
| `BOXER_LOG_FACTS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/keelson/runtime/factsstore/chstore` |
| `BOXER_LOG_FACTS_URL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/keelson/runtime/factsstore/chstore` |
...
| `BOXER_MAP_TILE_ATTRIBUTION` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MAP_TILE_ATTRIBUTION_URL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MAP_TILE_CA_FILE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MAP_TILE_INSECURE_TLS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MAP_TILE_MAX_ZOOM` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MAP_TILE_URL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/basemap` |
| `BOXER_MARKDOWN_ECHO` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/docgen` |
| `BOXER_MDEDIT_LLM_APIKEY` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/mdedit/transform` |
| `BOXER_MDEDIT_LLM_ENDPOINT` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/mdedit/transform` |
| `BOXER_MDEDIT_LLM_MAXTOKENS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/mdedit/transform` |
| `BOXER_MDEDIT_LLM_MODEL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/mdedit/transform` |
| `BOXER_MDEDIT_LLM_TIMEOUT` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/mdedit/transform` |
| `BOXER_PLAY_ALLOW_WRITES` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
...
| `BOXER_PLAY_FOCUS_CARDS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_CHART` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_CHAT` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_COMPLETION` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_DETAIL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_DIAGNOSTICS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_DIST` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_DOCS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_EDITOR` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_EXPERIMENTS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_FILES` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_FLOW` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_GLOSSES` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_GRAPH` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_GRAPHVIEW` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_HISTORY` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
...
| `BOXER_PLAY_FOCUS_PROJECTION` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_SANKEY` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_SCHEMA` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_SERIES` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_SNIPPETS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_TABLE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_TIMELINE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_TREEMAP` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_VECTORFIELD` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_PLAY_FOCUS_VOCABULARY` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
...
| `BOXER_PLAY_WINDOW_SIZE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
| `BOXER_SQLAPPLET_DATASET_EVENTS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/sqlapplet` |
| `BOXER_SQLAPPLET_DATASET_RECONCILE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/sqlapplet` |
| `BOXER_SQLAPPLET_WINDOW_SIZE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/sqlapplet` |
| `BOXER_WAIT_FOR_DEBUGGER` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/dev` |
| `BOXER_WAVEFORM_DEMO_FILE` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/demo/apps/widgets` |
...
| `IMZERO2_CLIENT_BINARY` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/imzero2env` |
...
| `IMZERO2_FFMPEG_BIN` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/imzero2env` |
...
| `IMZERO2_HEADLESS_RASTER_STATS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/imzero2env` |
| `IMZERO2_HEADLESS_RASTER_THREADS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/imzero2env` |
...
| `KEELSON_WATCHBILL_ABANDON_AFTER` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/keelson/runtime/watchbill` |
| `KEELSON_WATCHBILL_KEEP` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/keelson/runtime/watchbill` |
| `KEELSON_WATCHBILL_POLL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/keelson/runtime/watchbill` |
...
| `SCCMAP_REPO` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/demo/apps/sccmap` |
