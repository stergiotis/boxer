...
generated-at: 2026-06-17T17:53:51Z
---
...
69 variables across 11 categories, declared per ADR-0009. Re-run `go generate ./public/config/env/...` after adding or modifying specs.
...
| `HN_EXPLORER_CLICKHOUSE_URL` | string | — | — |  | ClickHouse URL backing the HN explorer demo; empty disables the demo's live queries |
...
| `IMZERO2_HEADLESS_CODEC` | categorial-string | `h264` | — |  | startup video codec lane: h264 (default; honours ENCODER_ARGS) \| vp9 \| av1; runtime-switchable from the Go control<br>**Allowed:** `h264` \| `vp9` \| `av1` |
...
| `HN_EXPLORER_CLICKHOUSE_URL` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/demo/apps/hn_explorer` |
