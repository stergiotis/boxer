...
generated-at: 2026-09-25T20:54:06Z
---
...
163 variables across 14 categories, declared per ADR-0009. Re-run `go generate ./public/config/env/...` after adding or modifying specs.
...
| `BOXER_PLAY_TAB_ZONES` | string | — | — |  | re-zone tabs at launch, as comma-separated id=zone pairs (zones: body, editor, tools, side, bottom; id * names every tab; later pairs win), e.g. "*=body" for one full-panel leaf; a pair naming an unknown tab or zone fails the mount |
...
| `IMZERO2_THEME` | string | — | — |  | IDS colour theme at launch: dark (the IDS palette, default) \| fresh (the light theme of ADR-0258); chosen once per process, not switchable at runtime |
...
| `BOXER_PLAY_EXPERIMENTS` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
...
| `BOXER_PLAY_TAB_ZONES` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/apps/play` |
...
| `IMZERO2_MARKDOWN_DEMO_PATH` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/egui2/demo/apps/widgets` |
...
| `IMZERO2_THEME` | `github.com/stergiotis/boxer` | `github.com/stergiotis/boxer/public/thestack/imzero2/imzero2env` |
