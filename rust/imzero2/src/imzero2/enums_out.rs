...
pub enum FuncProcId {
    ...
    FetchR7 = fenums::FUNC_PROC_ID_OFFSET + 50,
    FetchR9EtPrefetch = fenums::FUNC_PROC_ID_OFFSET + 51,
    FetchR9F64 = fenums::FUNC_PROC_ID_OFFSET + 52,
    FetchR9I64 = fenums::FUNC_PROC_ID_OFFSET + 53,
    FetchR9S = fenums::FUNC_PROC_ID_OFFSET + 54,
    FetchR9U64 = fenums::FUNC_PROC_ID_OFFSET + 55,
    FetchSnarlEvents = fenums::FUNC_PROC_ID_OFFSET + 56,
    FetchVideoCapabilities = fenums::FUNC_PROC_ID_OFFSET + 57,
    FetchVideoStreamInfo = fenums::FUNC_PROC_ID_OFFSET + 58,
    Frame = fenums::FUNC_PROC_ID_OFFSET + 59,
    Graph = fenums::FUNC_PROC_ID_OFFSET + 60,
    GraphEdge = fenums::FUNC_PROC_ID_OFFSET + 61,
    GraphNode = fenums::FUNC_PROC_ID_OFFSET + 62,
    Grid = fenums::FUNC_PROC_ID_OFFSET + 63,
    Group = fenums::FUNC_PROC_ID_OFFSET + 64,
    GuiZoomZoomMenuButtons = fenums::FUNC_PROC_ID_OFFSET + 65,
    H3CellsColored = fenums::FUNC_PROC_ID_OFFSET + 66,
    H3Region = fenums::FUNC_PROC_ID_OFFSET + 67,
    ...
    MapMarker = fenums::FUNC_PROC_ID_OFFSET + 82,
    MapPolyline = fenums::FUNC_PROC_ID_OFFSET + 83,
    MapRaster = fenums::FUNC_PROC_ID_OFFSET + 84,
    MeasureText = fenums::FUNC_PROC_ID_OFFSET + 85,
    MeasureTextSize = fenums::FUNC_PROC_ID_OFFSET + 86,
    MemoryResetAreas = fenums::FUNC_PROC_ID_OFFSET + 87,
    MenuBar = fenums::FUNC_PROC_ID_OFFSET + 88,
    MenuButton = fenums::FUNC_PROC_ID_OFFSET + 89,
    MoveWindowToTop = fenums::FUNC_PROC_ID_OFFSET + 90,
    NewTable = fenums::FUNC_PROC_ID_OFFSET + 91,
    NewTableColumn = fenums::FUNC_PROC_ID_OFFSET + 92,
    NewTableRowHeight = fenums::FUNC_PROC_ID_OFFSET + 93,
    NodeDir = fenums::FUNC_PROC_ID_OFFSET + 94,
    NodeDirClose = fenums::FUNC_PROC_ID_OFFSET + 95,
    NodeLeaf = fenums::FUNC_PROC_ID_OFFSET + 96,
    ...
    PaintCubicBezier = fenums::FUNC_PROC_ID_OFFSET + 102,
    PaintDashedLine = fenums::FUNC_PROC_ID_OFFSET + 103,
    PaintEllipseFilled = fenums::FUNC_PROC_ID_OFFSET + 104,
    PaintEllipseStroke = fenums::FUNC_PROC_ID_OFFSET + 105,
    PaintLine = fenums::FUNC_PROC_ID_OFFSET + 106,
    ...
    Plot = fenums::FUNC_PROC_ID_OFFSET + 124,
    PlotBars = fenums::FUNC_PROC_ID_OFFSET + 125,
    PlotBoxes = fenums::FUNC_PROC_ID_OFFSET + 126,
    PlotHLine = fenums::FUNC_PROC_ID_OFFSET + 127,
    PlotLine = fenums::FUNC_PROC_ID_OFFSET + 128,
    PlotPolygon = fenums::FUNC_PROC_ID_OFFSET + 129,
    PlotScatter = fenums::FUNC_PROC_ID_OFFSET + 130,
    PlotText = fenums::FUNC_PROC_ID_OFFSET + 131,
    PlotVLine = fenums::FUNC_PROC_ID_OFFSET + 132,
