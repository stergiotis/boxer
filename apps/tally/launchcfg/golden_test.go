...
// TestGeneratorMatchesCheckedInOutput pins the generated codec byte for byte
// (the ADR-0135 golden rule): a vocabulary or generator change shows up here
// as a diff, not as a silent drift between what is declared and what runs.
