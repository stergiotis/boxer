...
WITH m AS (
  SELECT * FROM values(
    ...
    ('b',   'Q1', 0.155, 0.117,   36932236), ('b',   'Q2', 1.091, 0.957,  649809773),
    ('b',   'Q3', 0.354, 0.338,   73739000), ('b',   'Q4', 0.804, 0.700,  527152393),
    ('b',   'Q5', 0.819, 0.714,  534244720),
    ('c',   'Q1', 0.151, 0.114,   53623712), ('c',   'Q2', 1.006, 0.925,  663142477),
    ('c',   'Q3', 0.355, 0.349,  202128029), ('c',   'Q4', 0.787, 0.713,  484389679),
    ('c',   'Q5', 0.800, 0.704,  506102935),
