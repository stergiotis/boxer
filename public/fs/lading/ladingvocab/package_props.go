...
//
// As for sysmvocab: the code here is pure declaration, but the registry it
// declares into reaches arrow-go — ladingvocab → leeway/namemint/registry →
// leeway/common → arrow/array.
