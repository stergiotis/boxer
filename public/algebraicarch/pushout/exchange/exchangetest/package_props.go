...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityNetwork, packageprops.CapabilityModifySystemState),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/algebraicarch/pushout/exchange/exchangetest", PackageProps)
}
