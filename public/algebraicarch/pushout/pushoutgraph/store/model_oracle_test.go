...
// pushoutgraph's rendered output must equal an independently tracked list of
...
// pushoutgraphs), this pins the engine's MEANING against a trivially correct
...
func mustLinearOrder(rt *rapid.T, g *PushoutGraph) []t.NodeID {
