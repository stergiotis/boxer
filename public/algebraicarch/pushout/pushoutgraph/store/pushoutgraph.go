// Package store provides the concrete PushoutGraph data structure implementing
...
// New creates an empty pushoutgraph with only the root node.
func New() *PushoutGraph {
	inst := &PushoutGraph{
		nodes:             t.NewNodeSet(),
...
func (inst *PushoutGraph) DeleteNode(id t.NodeID, deleter t.PatchHash) error {
	...
	// Record when the tombstone entered this pushoutgraph session, for
...
func (inst *PushoutGraph) addDeleter(id t.NodeID, deleter t.PatchHash) {
	set := inst.deleters[id]
	if set == nil {
...
func (inst *PushoutGraph) NodeDeleterCount(id t.NodeID) int {
...
func (inst *PushoutGraph) dropReasonsForRep(rep t.NodeID) {
...
func (inst *PushoutGraph) RemoveEdge(src, dest t.NodeID, kind t.EdgeKindE, patch t.PatchHash) {
...
func (inst *PushoutGraph) markDirtyAroundEdgeRemoval(src, dest t.NodeID) {
...
func (inst *PushoutGraph) addEdgeInternal(src, dest t.NodeID, kind t.EdgeKindE, patch t.PatchHash) {
	e := t.Edge{Dest: dest, Kind: kind, IntroducedBy: patch}
...
func (inst *PushoutGraph) removePseudoEdgeWithReasons(src, dest t.NodeID) {
...
func (inst *PushoutGraph) retagEdgesForDeletion(id t.NodeID) {
...
func (inst *PushoutGraph) retagEdgesForUndeletion(id t.NodeID) {
...
func (inst *PushoutGraph) mergeAdjacentDeleted(id t.NodeID) {
...
func (inst *PushoutGraph) ResolvePseudoEdges() {
...
func (inst *PushoutGraph) resolveComponent(rep t.NodeID) {
...
func (inst *PushoutGraph) findBoundaryNodes(component []t.NodeID) boundaryInfo {
	info := boundaryInfo{
...
func (inst *PushoutGraph) findReachableBoundary(src t.NodeID, component []t.NodeID, destSet map[t.NodeID]struct{}) []t.NodeID {
...
func (inst *PushoutGraph) recomputeDeletedComponents(members []t.NodeID) map[t.NodeID][]t.NodeID {
...
func (inst *PushoutGraph) LiveChildren(id t.NodeID) iter.Seq[t.NodeID] {
...
func (inst *PushoutGraph) LiveParents(id t.NodeID) iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
		for _, be := range inst.backEdges.Get(id) {
			if be.Kind == t.EdgeKindLive {
				if !yield(be.Dest) {
...
// AllLiveNodes yields all live node IDs in the pushoutgraph.
func (inst *PushoutGraph) AllLiveNodes() iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
...
func (inst *PushoutGraph) RemoveNode(id t.NodeID) {
	inst.nodes.Remove(id)
...
func (inst *PushoutGraph) NodeContent(id t.NodeID) []byte {
...
func (inst *PushoutGraph) NodeContentStatus(id t.NodeID) (status t.NodeContentStatusE) {
...
//   - Not safe for concurrent use with mutating pushoutgraph operations; the
...
func (inst *PushoutGraph) SweepTombstones(now time.Time, horizon time.Duration) (purgedCount int, purgedIDs []t.NodeID) {
...
// ignored.
func (inst *PushoutGraph) SeedTombstoneStamps(ledger map[t.NodeID]time.Time) {
...
// retention ledger.
func (inst *PushoutGraph) TombstoneStamps() map[t.NodeID]time.Time {
...
func (inst *PushoutGraph) AllDeletedNodes() iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
		for _, id := range inst.deletedNodes.Items() {
			if !yield(id) {
				return
...
func (inst *PushoutGraph) ForwardEdges(src t.NodeID) iter.Seq[t.Edge] {
...
func (inst *PushoutGraph) ForwardEdgeSources() iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
...
func (inst *PushoutGraph) BackwardEdges(dest t.NodeID) iter.Seq[t.Edge] {
	return func(yield func(t.Edge) bool) {
...
func (inst *PushoutGraph) BackwardEdgeSources() iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
...
func (inst *PushoutGraph) DeletedPartitionMembers(rep t.NodeID) iter.Seq[t.NodeID] {
	return func(yield func(t.NodeID) bool) {
...
func (inst *PushoutGraph) AllTrackedPseudoEdges() iter.Seq[[2]t.NodeID] {
	return func(yield func([2]t.NodeID) bool) {
...
func (inst *PushoutGraph) ExportFindBoundaryNodes(component []t.NodeID) (sources, dests []t.NodeID) {
...
func (inst *PushoutGraph) ExportFindReachableBoundary(src t.NodeID, component, dests []t.NodeID) []t.NodeID {
...
func (inst *PushoutGraph) CloneStore() t.GraphStoreI {
	return inst.Clone()
}

// Clone creates a deep copy of the pushoutgraph.
func (inst *PushoutGraph) Clone() *PushoutGraph {
	ng := New()
	...
	// Propagate the clock so a clone of a pushoutgraph with a test clock
	// keeps the test clock; production clones inherit time.Now.
	ng.clock = inst.clock
	return ng
}

// Debug returns a human-readable dump of the pushoutgraph.
func (inst *PushoutGraph) Debug() string {
