...
// all other pushoutgraph sub-packages import it, and it imports nothing internal.
package types
...
// NodeID uniquely identifies a line/node in the pushoutgraph.
...
// RootNodeID is the sentinel root node present in every pushoutgraph.
...
// EdgeKindE classifies edges in the pushoutgraph.
...
// has no entry. Callers that surface pushoutgraph state to data-protection
...
// Edge represents a directed edge in the pushoutgraph.
type Edge struct {
	Dest         NodeID
	Kind         EdgeKindE
