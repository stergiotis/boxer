...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityModifySystemState, packageprops.CapabilitySystemCalls),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/algebraicarch/pushout/repo/filestore", PackageProps)
}
