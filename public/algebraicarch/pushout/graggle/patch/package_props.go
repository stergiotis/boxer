...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityRuntime, packageprops.CapabilityModifySystemState, packageprops.CapabilitySystemCalls, packageprops.CapabilityReflect),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/algebraicarch/pushout/graggle/patch", PackageProps)
}
