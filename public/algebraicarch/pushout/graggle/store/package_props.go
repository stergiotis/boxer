...
var PackageProps = packageprops.Props{
	...
	CapsReachable:    packageprops.Caps(packageprops.CapabilityArbitraryExecution),
}

func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/algebraicarch/pushout/graggle/store", PackageProps)
}
