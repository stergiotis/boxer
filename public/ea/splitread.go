...
func TransferDataWithSplitReadAndWrites(dest ByteBlockWriterI, nBytesToRead int, r ByteReadReaderI, maxConsecutiveBytesToRead int, ra *rand.Rand) (singleByteReads int, blockReads int, bytesBlockReads int, n int, err error) {
