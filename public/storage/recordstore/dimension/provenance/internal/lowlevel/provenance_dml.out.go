...
func CreateSchemaProvenanceTable() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		...
		/* 002 */ arrow.Field{Name: "tv:symbol:value:val:s:m:0:12:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
		...
		/* 005 */ arrow.Field{Name: "tv:symbolArray:value:val:sh:g:0:12:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
