...
var LedgerMembershipIds = map[string]map[string]uint64{
	"Opened": {
		"ledgerOwner": 1,
	},
	"Deposited": {
...
// LedgerMembershipIds against the writer's assignment when pointing this
// store at rows it did not write.
func (inst *LedgerStore) VerifySchema(ctx context.Context) (err error) {
	live := make([]string, 0, 64)
	for rec, rerr := range inst.exec.QueryArrow(ctx, "DESCRIBE TABLE "+inst.tableName()+ledgerArrowOutputSettings) {
		if rerr != nil {
...
const (
	...
	ledgerScanDepositedFilter    = "has(\"tv:acctDeposit:lr:lr:u64:1247:::0::data\", 1) AND countEqual(\"tv:acctDeposit:lr:lr:u64:1247:::0::data\", 1) = 1 AND if(has(\"tv:acctDeposit:lr:lr:u64:1247:::0::data\", 1), \"tv:acctDeposit:len:len:u64:4D:::0::data\"[arrayFirstIndex(cum -> cum >= indexOf(\"tv:acctDeposit:lr:lr:u64:1247:::0::data\", 1), arrayCumSum(\"tv:acctDeposit:lrcard:lrcard:u64:4E:::0::data\"))], 0) = 1"
	ledgerScanWithdrawnFilter    = "has(\"tv:acctWithdraw:lr:lr:u64:1247:::0::data\", 1) AND countEqual(\"tv:acctWithdraw:lr:lr:u64:1247:::0::data\", 1) = 1 AND if(has(\"tv:acctWithdraw:lr:lr:u64:1247:::0::data\", 1), \"tv:acctWithdraw:len:len:u64:4D:::0::data\"[arrayFirstIndex(cum -> cum >= indexOf(\"tv:acctWithdraw:lr:lr:u64:1247:::0::data\", 1), arrayCumSum(\"tv:acctWithdraw:lrcard:lrcard:u64:4E:::0::data\"))], 0) = 1"
