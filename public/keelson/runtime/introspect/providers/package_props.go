...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityOperatingSystem),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/keelson/runtime/introspect/providers", PackageProps)
}
