...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityNetwork),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/keelson/runtime/introspect/introspecthttp", PackageProps)
}
