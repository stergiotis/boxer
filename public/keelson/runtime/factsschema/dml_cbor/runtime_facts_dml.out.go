// Code generated by Leeway DML (regen); DO NOT EDIT.
...
func CreateSchemaFacts() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		...
		/* 007 */ arrow.Field{Name: "tv:textArray:value:val:sh:w:0:gw:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
		...
		/* 016 */ arrow.Field{Name: "tv:stringArray:value:val:sh:g:0:x2:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
