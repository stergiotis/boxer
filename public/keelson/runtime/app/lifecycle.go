...
// subscribes and releases the rest. The payload is the generated
// instanceclosed.InstanceClosed codec; the envelope's sender is the closed
// client's own identity. A client with no instance key (a service, a CLI,
// a test) announces nothing: there is no instance to own anything.
