...
//
// Likely to end Blocked once probed: it hosts the imzero2 application and the
// window host, and every widget package the 2026-06-12 probe reached came
// back Blocked on the egui2 bindings.
