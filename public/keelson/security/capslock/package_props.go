...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityRuntime, packageprops.CapabilityModifySystemState, packageprops.CapabilitySystemCalls),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/keelson/security/capslock", PackageProps)
}
