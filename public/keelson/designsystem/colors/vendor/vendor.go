...
//     src/rust/assets/colors/scientific/upstream/, originally
...
//
// Emits to:
//   - src/rust/imzero2_egui/src/style/data_encoding/<palette>.rs
...
func Run(ctx context.Context, cfg Config) (res Result, err error) {
	...
	upstreamDir := filepath.Join(repoRoot,
		"src/rust/assets/colors/scientific/upstream")
	rustDir := filepath.Join(repoRoot,
		"src/rust/imzero2_egui/src/style/data_encoding")
...
func assemble(upstreamDir string) (out []lut, err error) {
	...
	// ---- Crameri batlowS qualitative — 100 lines upstream; sample 10 ----
	var bS lut
	...
	bS.Cardinality = 10
	bS.RGB = sampleEvenly(bS.RGB, 10)
	bS.Family = "crameri"
	bS.License = "MIT"
	bS.Provenance = "Fabio Crameri, batlowS categorical sampling " +
		"(Zenodo DOI 10.5281/zenodo.1243862); 10-color subset per ADR-0033 §SD4."
	out = append(out, bS)
...
// sampleEvenly picks count entries linearly across src, including endpoints.
func sampleEvenly(src [][3]uint8, count int) (out [][3]uint8) {
...
func emitRust(l lut) (s string) {
	...
	fmt.Fprintf(&sb, "// Code generated by ./cmd/designsystem colors vendor — DO NOT EDIT.\n")
...
func emitRustMod(luts []lut) (s string) {
	...
	sb.WriteString("//!\n")
	sb.WriteString("//! Code generated by ./cmd/designsystem colors vendor — DO NOT EDIT.\n\n")
	for _, l := range luts {
		fmt.Fprintf(&sb, "pub mod %s;\n", l.Name)
	}
	sb.WriteString("\n")
	for _, l := range luts {
		fmt.Fprintf(&sb, "pub use %s::%s;\n", l.Name, rustIdent(l.Name))
	}
	s = sb.String()
	return
}
