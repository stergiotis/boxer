...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityRuntime, packageprops.CapabilityModifySystemState, packageprops.CapabilitySystemCalls, packageprops.CapabilityUnsafePointer, packageprops.CapabilityReflect),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/keelson/designsystem/colors/ipboundary", PackageProps)
}
