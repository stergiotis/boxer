...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityNetwork, packageprops.CapabilityUnsafePointer),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/observability/sysmetrics/psi", PackageProps)
}
