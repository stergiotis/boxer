...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityReadSystemState),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/observability/coverage", PackageProps)
}
