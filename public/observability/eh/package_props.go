...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityReadSystemState, packageprops.CapabilityModifySystemState, packageprops.CapabilityExec),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/observability/eh", PackageProps)
}
