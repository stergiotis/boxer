...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityNetwork, packageprops.CapabilityRuntime, packageprops.CapabilityModifySystemState),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/observability/eh/eb", PackageProps)
}
