...
func (inst *CodeTransformerBackendPresenterCpp) emitDispatcher(out io.Writer, preamble []byte) (n int, err error) {
	if preamble == nil {
		preamble = []byte{}
	}
...
func (inst *CodeTransformerBackendPresenterCpp) Emit(out io.Writer, preamble []byte) (n int, err error) {
	return inst.emitDispatcher(out, preamble)
}
