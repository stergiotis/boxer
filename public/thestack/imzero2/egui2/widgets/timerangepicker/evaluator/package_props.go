...
//
// Follows chlocalbroker's verdict, and only transitively: the evaluator
// resolves range expressions through it — evaluator →
// keelson/data/chlocalbroker → keelson/runtime/adhocdata → arrow/ipc.
// Nothing here imports arrow directly.
