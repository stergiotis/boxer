...
func CreateSchemaFixture() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		/* 000 */ arrow.Field{Name: "id:id:u64:4:78:0:", Nullable: false, Type: arrow.PrimitiveTypes.Uint64},
		/* 001 */ arrow.Field{Name: "id:internalKey:s:4:8:0:", Nullable: false, Type: &arrow.StringType{}},
		/* 002 */ arrow.Field{Name: "id:naturalKey:s:4:78:0:", Nullable: false, Type: &arrow.StringType{}},
		/* 003 */ arrow.Field{Name: "tv:metric:value:val:f64:4::78:0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Float64)},
		/* 004 */ arrow.Field{Name: "tv:metric:rawBlob:val:s:4::8:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
		/* 005 */ arrow.Field{Name: "tv:metric:tags:val:sh:4::78:0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
		/* 006 */ arrow.Field{Name: "tv:metric:bins:val:u32m:4::78:0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint32)},
		/* 007 */ arrow.Field{Name: "tv:metric:lr:lr:u64:1247:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 008 */ arrow.Field{Name: "tv:metric:lv:lv:y:124:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 009 */ arrow.Field{Name: "tv:metric:lp:lp:y:4:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 010 */ arrow.Field{Name: "tv:metric:lmr:lmr:u64:1247:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 011 */ arrow.Field{Name: "tv:metric:mrhp:mrhp:y:4:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 012 */ arrow.Field{Name: "tv:metric:lmv:lmv:y:124:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 013 */ arrow.Field{Name: "tv:metric:mvhp:mvhp:y:4:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 014 */ arrow.Field{Name: "tv:metric:len:len:u64:4D:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 015 */ arrow.Field{Name: "tv:metric:card:card:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 016 */ arrow.Field{Name: "tv:metric:lrcard:lrcard:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 017 */ arrow.Field{Name: "tv:metric:lvcard:lvcard:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 018 */ arrow.Field{Name: "tv:metric:lpcard:lpcard:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 019 */ arrow.Field{Name: "tv:metric:lmrcard:lmrcard:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 020 */ arrow.Field{Name: "tv:metric:lmvcard:lmvcard:u64:4E:::0::data", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 021 */ arrow.Field{Name: "tv:geoPoint:lat:val:f32:4::78:0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Float32)},
		/* 022 */ arrow.Field{Name: "tv:geoPoint:lng:val:f32:4::78:0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Float32)},
		/* 023 */ arrow.Field{Name: "tv:geoPoint:lv:lv:y:124:::0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 024 */ arrow.Field{Name: "tv:geoPoint:lvcard:lvcard:u64:4E:::0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 025 */ arrow.Field{Name: "tv:geoArea:code:val:s:4::78:0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
		/* 026 */ arrow.Field{Name: "tv:geoArea:poly:val:f32h:4::78:0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Float32)},
		/* 027 */ arrow.Field{Name: "tv:geoArea:len:len:u64:4D:::0:geo:geo", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
	}, nil)
	return
}
...
// left behind.
func (inst *InEntityFixture) ClearMembershipsHighCardRef() {
