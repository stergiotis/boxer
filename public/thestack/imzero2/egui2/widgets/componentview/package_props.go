...
//
// Rendering leeway components means reading them reflectively, and the
// reflective marshaller's closure reaches arrow-go — componentview →
// leeway/marshall/go/marshallreflect → arrow/array. The dependency is what
// the widget is for.
//
