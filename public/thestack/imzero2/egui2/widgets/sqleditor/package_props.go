...
//
// Likely to end Blocked once probed: every widget package the 2026-06-12
// probe reached came back Blocked on the egui2 bindings; this one was never
// probed because the arrow seed pruned it first.
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/thestack/imzero2/egui2/widgets/sqleditor", PackageProps)
}
