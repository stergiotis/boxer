...
func TestForceParamsDefaultsMatchTheBinding(t *testing.T) {
	p := ForceParams{}.withDefaults()
	require.Equal(t, ForceParams{Dt: 0.05, Damping: 0.3, Epsilon: 1e-3, MaxStep: 10, KScale: 1, CAttract: 1, CRepulse: 1, CenterGravity: 0.3, Theta: defaultTheta, Exaggeration: 1}, p)
