...
type DockAreaRawFluid struct {
	...
	id              uint64
	idGen           WidgetIdCreatorI
	deferredTabBody *runtime.DeferredBlockScope
}
...
type HoverUiFluid struct {
	r              *typed.RetainedFffiBuilder
	deferredTip    *runtime.DeferredBlockScope
...
var _ WidgetI = SelectableLabelS{}
