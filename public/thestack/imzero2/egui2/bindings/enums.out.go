...
const (
	...
	FuncProcIdMeasureTextSize                     FuncProcIdE = FuncProcIdOffset + 81
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 90
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 91
	FuncProcIdPaintAbsoluteOverlay                FuncProcIdE = FuncProcIdOffset + 92
	FuncProcIdPaintArrow                          FuncProcIdE = FuncProcIdOffset + 93
	FuncProcIdPaintCanvas                         FuncProcIdE = FuncProcIdOffset + 94
	FuncProcIdPaintCircleFilled                   FuncProcIdE = FuncProcIdOffset + 95
	FuncProcIdPaintCircleStroke                   FuncProcIdE = FuncProcIdOffset + 96
	FuncProcIdPaintCubicBezier                    FuncProcIdE = FuncProcIdOffset + 97
	FuncProcIdPaintDashedLine                     FuncProcIdE = FuncProcIdOffset + 98
	FuncProcIdPaintEllipseFilled                  FuncProcIdE = FuncProcIdOffset + 99
	FuncProcIdPaintEllipseStroke                  FuncProcIdE = FuncProcIdOffset + 100
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 101
	FuncProcIdPaintPolygonFilled                  FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintPolyline                       FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPaintRectFilled                     FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPaintRectStroke                     FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPaintSenseRegion                    FuncProcIdE = FuncProcIdOffset + 106
	FuncProcIdPaintText                           FuncProcIdE = FuncProcIdOffset + 107
	FuncProcIdPanelBottom                         FuncProcIdE = FuncProcIdOffset + 108
	FuncProcIdPanelBottomInside                   FuncProcIdE = FuncProcIdOffset + 109
	FuncProcIdPanelCentral                        FuncProcIdE = FuncProcIdOffset + 110
	FuncProcIdPanelCentralInside                  FuncProcIdE = FuncProcIdOffset + 111
	FuncProcIdPanelLeft                           FuncProcIdE = FuncProcIdOffset + 112
	FuncProcIdPanelLeftInside                     FuncProcIdE = FuncProcIdOffset + 113
	FuncProcIdPanelRight                          FuncProcIdE = FuncProcIdOffset + 114
	FuncProcIdPanelRightInside                    FuncProcIdE = FuncProcIdOffset + 115
	FuncProcIdPanelTop                            FuncProcIdE = FuncProcIdOffset + 116
	FuncProcIdPanelTopInside                      FuncProcIdE = FuncProcIdOffset + 117
	FuncProcIdPassthrough                         FuncProcIdE = FuncProcIdOffset + 118
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 119
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 120
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 121
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 122
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPrepareNextFrame                    FuncProcIdE = FuncProcIdOffset + 128
	FuncProcIdProgressBar                         FuncProcIdE = FuncProcIdOffset + 129
	FuncProcIdPushId                              FuncProcIdE = FuncProcIdOffset + 130
	FuncProcIdRadioButton                         FuncProcIdE = FuncProcIdOffset + 131
	FuncProcIdRequestRepaint                      FuncProcIdE = FuncProcIdOffset + 132
	FuncProcIdRequestRepaintAfter                 FuncProcIdE = FuncProcIdOffset + 133
	FuncProcIdRequestScreenshot                   FuncProcIdE = FuncProcIdOffset + 134
	FuncProcIdRequestScreenshotRect               FuncProcIdE = FuncProcIdOffset + 135
	FuncProcIdScalarSize                          FuncProcIdE = FuncProcIdOffset + 136
	FuncProcIdScope                               FuncProcIdE = FuncProcIdOffset + 137
	FuncProcIdScrollArea                          FuncProcIdE = FuncProcIdOffset + 138
	FuncProcIdScrollToCursor                      FuncProcIdE = FuncProcIdOffset + 139
	FuncProcIdScrollingTexture                    FuncProcIdE = FuncProcIdOffset + 140
	FuncProcIdScrollingTextureRelease             FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdSelectableLabel                     FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdSeparator                           FuncProcIdE = FuncProcIdOffset + 143
	FuncProcIdSetAnimationFreeze                  FuncProcIdE = FuncProcIdOffset + 144
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 145
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 146
	FuncProcIdShowPuffinProfiler                  FuncProcIdE = FuncProcIdOffset + 147
	...
	FuncProcIdSnarlConnection                     FuncProcIdE = FuncProcIdOffset + 151
	FuncProcIdSnarlEditor                         FuncProcIdE = FuncProcIdOffset + 152
	FuncProcIdSnarlNode                           FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdSnarlPin                            FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdSpinner                             FuncProcIdE = FuncProcIdOffset + 155
	...
	FuncProcIdTree                                FuncProcIdE = FuncProcIdOffset + 164
	FuncProcIdUiDisable                           FuncProcIdE = FuncProcIdOffset + 165
	FuncProcIdUiSetHeight                         FuncProcIdE = FuncProcIdOffset + 166
	FuncProcIdUiSetMaxHeight                      FuncProcIdE = FuncProcIdOffset + 167
	FuncProcIdUiSetMaxWidth                       FuncProcIdE = FuncProcIdOffset + 168
	FuncProcIdUiSetMinHeight                      FuncProcIdE = FuncProcIdOffset + 169
	FuncProcIdUiSetMinWidth                       FuncProcIdE = FuncProcIdOffset + 170
	...
	FuncProcIdWalkersMap                          FuncProcIdE = FuncProcIdOffset + 177
	FuncProcIdWarnIfDebugBuild                    FuncProcIdE = FuncProcIdOffset + 178
	FuncProcIdWidgetText                          FuncProcIdE = FuncProcIdOffset + 179
	FuncProcIdWidgetsGlobalThemePreferenceButtons FuncProcIdE = FuncProcIdOffset + 180
	FuncProcIdWindow                              FuncProcIdE = FuncProcIdOffset + 181
)
const (
