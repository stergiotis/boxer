...
const (
	...
	FuncProcIdFetchR7                             FuncProcIdE = FuncProcIdOffset + 49
	FuncProcIdFetchR9EtPrefetch                   FuncProcIdE = FuncProcIdOffset + 50
	FuncProcIdFetchR9F64                          FuncProcIdE = FuncProcIdOffset + 51
	FuncProcIdFetchR9I64                          FuncProcIdE = FuncProcIdOffset + 52
	FuncProcIdFetchR9S                            FuncProcIdE = FuncProcIdOffset + 53
	FuncProcIdFetchR9U64                          FuncProcIdE = FuncProcIdOffset + 54
	FuncProcIdFetchSnarlEvents                    FuncProcIdE = FuncProcIdOffset + 55
	FuncProcIdFetchVideoCapabilities              FuncProcIdE = FuncProcIdOffset + 56
	FuncProcIdFetchVideoStreamInfo                FuncProcIdE = FuncProcIdOffset + 57
	FuncProcIdFrame                               FuncProcIdE = FuncProcIdOffset + 58
	FuncProcIdGraph                               FuncProcIdE = FuncProcIdOffset + 59
	FuncProcIdGraphEdge                           FuncProcIdE = FuncProcIdOffset + 60
	FuncProcIdGraphNode                           FuncProcIdE = FuncProcIdOffset + 61
	FuncProcIdGrid                                FuncProcIdE = FuncProcIdOffset + 62
	FuncProcIdGroup                               FuncProcIdE = FuncProcIdOffset + 63
	FuncProcIdGuiZoomZoomMenuButtons              FuncProcIdE = FuncProcIdOffset + 64
	FuncProcIdH3CellsColored                      FuncProcIdE = FuncProcIdOffset + 65
	FuncProcIdH3Region                            FuncProcIdE = FuncProcIdOffset + 66
	FuncProcIdHorizontal                          FuncProcIdE = FuncProcIdOffset + 67
	FuncProcIdHorizontalCentered                  FuncProcIdE = FuncProcIdOffset + 68
	FuncProcIdHorizontalTop                       FuncProcIdE = FuncProcIdOffset + 69
	FuncProcIdHorizontalWrapped                   FuncProcIdE = FuncProcIdOffset + 70
	FuncProcIdHoverText                           FuncProcIdE = FuncProcIdOffset + 71
	FuncProcIdHoverUi                             FuncProcIdE = FuncProcIdOffset + 72
	FuncProcIdHyperlink                           FuncProcIdE = FuncProcIdOffset + 73
	FuncProcIdHyperlinkTo                         FuncProcIdE = FuncProcIdOffset + 74
	FuncProcIdImage                               FuncProcIdE = FuncProcIdOffset + 75
	FuncProcIdImageRelease                        FuncProcIdE = FuncProcIdOffset + 76
	FuncProcIdIndent                              FuncProcIdE = FuncProcIdOffset + 77
	FuncProcIdLabel                               FuncProcIdE = FuncProcIdOffset + 78
	FuncProcIdLabelAtoms                          FuncProcIdE = FuncProcIdOffset + 79
	FuncProcIdLabelWidgetText                     FuncProcIdE = FuncProcIdOffset + 80
	FuncProcIdMapMarker                           FuncProcIdE = FuncProcIdOffset + 81
	FuncProcIdMapPolyline                         FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMapRaster                           FuncProcIdE = FuncProcIdOffset + 83
	...
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 93
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 94
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 95
	FuncProcIdPaintAbsoluteOverlay                FuncProcIdE = FuncProcIdOffset + 96
	FuncProcIdPaintArrow                          FuncProcIdE = FuncProcIdOffset + 97
	FuncProcIdPaintCanvas                         FuncProcIdE = FuncProcIdOffset + 98
	FuncProcIdPaintCircleFilled                   FuncProcIdE = FuncProcIdOffset + 99
	FuncProcIdPaintCircleStroke                   FuncProcIdE = FuncProcIdOffset + 100
	FuncProcIdPaintCubicBezier                    FuncProcIdE = FuncProcIdOffset + 101
	FuncProcIdPaintDashedLine                     FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintEllipseFilled                  FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPaintEllipseStroke                  FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPaintPolygonFilled                  FuncProcIdE = FuncProcIdOffset + 106
	FuncProcIdPaintPolyline                       FuncProcIdE = FuncProcIdOffset + 107
	FuncProcIdPaintRectFilled                     FuncProcIdE = FuncProcIdOffset + 108
	FuncProcIdPaintRectStroke                     FuncProcIdE = FuncProcIdOffset + 109
	...
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 128
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 129
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 130
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 131
