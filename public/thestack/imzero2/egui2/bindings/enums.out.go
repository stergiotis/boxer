...
const (
	FuncProcIdAccessibleRegion                    FuncProcIdE = FuncProcIdOffset + 0
	FuncProcIdAddSpace                            FuncProcIdE = FuncProcIdOffset + 1
	FuncProcIdAllocateUiAtRect                    FuncProcIdE = FuncProcIdOffset + 2
	FuncProcIdAnimateBoolResponsive               FuncProcIdE = FuncProcIdOffset + 3
	FuncProcIdAnimateBoolWithTime                 FuncProcIdE = FuncProcIdOffset + 4
	FuncProcIdAnimateValueWithTime                FuncProcIdE = FuncProcIdOffset + 5
	FuncProcIdAtoms                               FuncProcIdE = FuncProcIdOffset + 6
	FuncProcIdButton                              FuncProcIdE = FuncProcIdOffset + 7
	FuncProcIdCaptureAvailableSize                FuncProcIdE = FuncProcIdOffset + 8
	FuncProcIdCaptureUiAvailableRect              FuncProcIdE = FuncProcIdOffset + 9
	FuncProcIdCaptureUiRect                       FuncProcIdE = FuncProcIdOffset + 10
	FuncProcIdCheckbox                            FuncProcIdE = FuncProcIdOffset + 11
	FuncProcIdCodeView                            FuncProcIdE = FuncProcIdOffset + 12
	FuncProcIdCodeViewJob                         FuncProcIdE = FuncProcIdOffset + 13
	FuncProcIdCollapsingHeader                    FuncProcIdE = FuncProcIdOffset + 14
	FuncProcIdColor                               FuncProcIdE = FuncProcIdOffset + 15
	FuncProcIdComboBox                            FuncProcIdE = FuncProcIdOffset + 16
	FuncProcIdContextInspectionUi                 FuncProcIdE = FuncProcIdOffset + 17
	FuncProcIdContextMenu                         FuncProcIdE = FuncProcIdOffset + 18
	FuncProcIdContextSendViewPortCommandClose     FuncProcIdE = FuncProcIdOffset + 19
	FuncProcIdCopyTextToClipboard                 FuncProcIdE = FuncProcIdOffset + 20
	FuncProcIdDatePickerButton                    FuncProcIdE = FuncProcIdOffset + 21
	FuncProcIdDateTimePickerButton                FuncProcIdE = FuncProcIdOffset + 22
	FuncProcIdDockAreaRaw                         FuncProcIdE = FuncProcIdOffset + 23
	FuncProcIdDragValueF64                        FuncProcIdE = FuncProcIdOffset + 24
	FuncProcIdDragValueI64                        FuncProcIdE = FuncProcIdOffset + 25
	FuncProcIdDragValueU64                        FuncProcIdE = FuncProcIdOffset + 26
	FuncProcIdEnabledUi                           FuncProcIdE = FuncProcIdOffset + 27
	FuncProcIdEnd                                 FuncProcIdE = FuncProcIdOffset + 28
	FuncProcIdEndETable                           FuncProcIdE = FuncProcIdOffset + 29
	FuncProcIdEndRow                              FuncProcIdE = FuncProcIdOffset + 30
	FuncProcIdEtColumn                            FuncProcIdE = FuncProcIdOffset + 31
	FuncProcIdEtHeaderText                        FuncProcIdE = FuncProcIdOffset + 32
	FuncProcIdEtRowHeight                         FuncProcIdE = FuncProcIdOffset + 33
	FuncProcIdExportSvg                           FuncProcIdE = FuncProcIdOffset + 34
	FuncProcIdExportSvgWindow                     FuncProcIdE = FuncProcIdOffset + 35
	FuncProcIdFetchCommandEnterPressed            FuncProcIdE = FuncProcIdOffset + 36
	FuncProcIdFetchF1KeyPressed                   FuncProcIdE = FuncProcIdOffset + 37
	FuncProcIdFetchF2KeyPressed                   FuncProcIdE = FuncProcIdOffset + 38
	FuncProcIdFetchFrameMetrics                   FuncProcIdE = FuncProcIdOffset + 39
	FuncProcIdFetchGraphEvents                    FuncProcIdE = FuncProcIdOffset + 40
	FuncProcIdFetchGraphMetrics                   FuncProcIdE = FuncProcIdOffset + 41
	FuncProcIdFetchGraphSelection                 FuncProcIdE = FuncProcIdOffset + 42
	FuncProcIdFetchR10                            FuncProcIdE = FuncProcIdOffset + 43
	FuncProcIdFetchR16ScrollDelta                 FuncProcIdE = FuncProcIdOffset + 44
	FuncProcIdFetchR17Modifiers                   FuncProcIdE = FuncProcIdOffset + 45
	FuncProcIdFetchR18AvailableSize               FuncProcIdE = FuncProcIdOffset + 46
	FuncProcIdFetchR19ZoomDelta                   FuncProcIdE = FuncProcIdOffset + 47
	FuncProcIdFetchR20Pointer                     FuncProcIdE = FuncProcIdOffset + 48
	FuncProcIdFetchR21UiRects                     FuncProcIdE = FuncProcIdOffset + 49
	FuncProcIdFetchR22StarvedTextures             FuncProcIdE = FuncProcIdOffset + 50
	FuncProcIdFetchR23CanvasWheel                 FuncProcIdE = FuncProcIdOffset + 51
	FuncProcIdFetchR24CanvasPointers              FuncProcIdE = FuncProcIdOffset + 52
	FuncProcIdFetchR25EtColWidths                 FuncProcIdE = FuncProcIdOffset + 53
	FuncProcIdFetchR26KeyCaptures                 FuncProcIdE = FuncProcIdOffset + 54
	FuncProcIdFetchR7                             FuncProcIdE = FuncProcIdOffset + 55
	FuncProcIdFetchR9EtPrefetch                   FuncProcIdE = FuncProcIdOffset + 56
	FuncProcIdFetchR9F64                          FuncProcIdE = FuncProcIdOffset + 57
	FuncProcIdFetchR9I64                          FuncProcIdE = FuncProcIdOffset + 58
	FuncProcIdFetchR9S                            FuncProcIdE = FuncProcIdOffset + 59
	FuncProcIdFetchR9U64                          FuncProcIdE = FuncProcIdOffset + 60
	FuncProcIdFetchVideoCapabilities              FuncProcIdE = FuncProcIdOffset + 61
	FuncProcIdFetchVideoStreamInfo                FuncProcIdE = FuncProcIdOffset + 62
	FuncProcIdFrame                               FuncProcIdE = FuncProcIdOffset + 63
	FuncProcIdGraph                               FuncProcIdE = FuncProcIdOffset + 64
	FuncProcIdGraphEdge                           FuncProcIdE = FuncProcIdOffset + 65
	FuncProcIdGraphNode                           FuncProcIdE = FuncProcIdOffset + 66
	FuncProcIdGrid                                FuncProcIdE = FuncProcIdOffset + 67
	FuncProcIdGroup                               FuncProcIdE = FuncProcIdOffset + 68
	FuncProcIdGuiZoomZoomMenuButtons              FuncProcIdE = FuncProcIdOffset + 69
	FuncProcIdHorizontal                          FuncProcIdE = FuncProcIdOffset + 70
	FuncProcIdHorizontalCentered                  FuncProcIdE = FuncProcIdOffset + 71
	FuncProcIdHorizontalTop                       FuncProcIdE = FuncProcIdOffset + 72
	FuncProcIdHorizontalWrapped                   FuncProcIdE = FuncProcIdOffset + 73
	FuncProcIdHoverText                           FuncProcIdE = FuncProcIdOffset + 74
	FuncProcIdHoverUi                             FuncProcIdE = FuncProcIdOffset + 75
	FuncProcIdHyperlink                           FuncProcIdE = FuncProcIdOffset + 76
	FuncProcIdHyperlinkTo                         FuncProcIdE = FuncProcIdOffset + 77
	FuncProcIdImage                               FuncProcIdE = FuncProcIdOffset + 78
	FuncProcIdImageRelease                        FuncProcIdE = FuncProcIdOffset + 79
	FuncProcIdIndent                              FuncProcIdE = FuncProcIdOffset + 80
	FuncProcIdLabel                               FuncProcIdE = FuncProcIdOffset + 81
	FuncProcIdLabelAtoms                          FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdLabelWidgetText                     FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMeasureText                         FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdMeasureTextSize                     FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 90
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 91
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 92
	FuncProcIdPaintAbsoluteOverlay                FuncProcIdE = FuncProcIdOffset + 93
	FuncProcIdPaintArrow                          FuncProcIdE = FuncProcIdOffset + 94
	FuncProcIdPaintCanvas                         FuncProcIdE = FuncProcIdOffset + 95
	FuncProcIdPaintCircleFilled                   FuncProcIdE = FuncProcIdOffset + 96
	FuncProcIdPaintCircleStroke                   FuncProcIdE = FuncProcIdOffset + 97
	FuncProcIdPaintClipPop                        FuncProcIdE = FuncProcIdOffset + 98
	FuncProcIdPaintClipPush                       FuncProcIdE = FuncProcIdOffset + 99
	FuncProcIdPaintCubicBezier                    FuncProcIdE = FuncProcIdOffset + 100
	FuncProcIdPaintDashedLine                     FuncProcIdE = FuncProcIdOffset + 101
	FuncProcIdPaintEllipseFilled                  FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintEllipseStroke                  FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPaintImage                          FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPaintMarkers                        FuncProcIdE = FuncProcIdOffset + 106
	FuncProcIdPaintPolygonFilled                  FuncProcIdE = FuncProcIdOffset + 107
	FuncProcIdPaintPolyline                       FuncProcIdE = FuncProcIdOffset + 108
	FuncProcIdPaintRectFilled                     FuncProcIdE = FuncProcIdOffset + 109
	FuncProcIdPaintRectStroke                     FuncProcIdE = FuncProcIdOffset + 110
	FuncProcIdPaintRectsFilled                    FuncProcIdE = FuncProcIdOffset + 111
	FuncProcIdPaintSegments                       FuncProcIdE = FuncProcIdOffset + 112
	FuncProcIdPaintSenseRegion                    FuncProcIdE = FuncProcIdOffset + 113
	FuncProcIdPaintText                           FuncProcIdE = FuncProcIdOffset + 114
	FuncProcIdPanelBottom                         FuncProcIdE = FuncProcIdOffset + 115
	FuncProcIdPanelBottomInside                   FuncProcIdE = FuncProcIdOffset + 116
	FuncProcIdPanelCentral                        FuncProcIdE = FuncProcIdOffset + 117
	FuncProcIdPanelCentralInside                  FuncProcIdE = FuncProcIdOffset + 118
	FuncProcIdPanelLeft                           FuncProcIdE = FuncProcIdOffset + 119
	FuncProcIdPanelLeftInside                     FuncProcIdE = FuncProcIdOffset + 120
	FuncProcIdPanelRight                          FuncProcIdE = FuncProcIdOffset + 121
	FuncProcIdPanelRightInside                    FuncProcIdE = FuncProcIdOffset + 122
	FuncProcIdPanelTop                            FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPanelTopInside                      FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPassthrough                         FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPrepareNextFrame                    FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdProgressBar                         FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPushId                              FuncProcIdE = FuncProcIdOffset + 128
	FuncProcIdRadioButton                         FuncProcIdE = FuncProcIdOffset + 129
	FuncProcIdRequestFocus                        FuncProcIdE = FuncProcIdOffset + 130
	FuncProcIdRequestRepaint                      FuncProcIdE = FuncProcIdOffset + 131
	FuncProcIdRequestRepaintAfter                 FuncProcIdE = FuncProcIdOffset + 132
	FuncProcIdRequestScreenshot                   FuncProcIdE = FuncProcIdOffset + 133
	FuncProcIdRequestScreenshotRect               FuncProcIdE = FuncProcIdOffset + 134
	FuncProcIdScalarSize                          FuncProcIdE = FuncProcIdOffset + 135
	FuncProcIdScope                               FuncProcIdE = FuncProcIdOffset + 136
	FuncProcIdScrollArea                          FuncProcIdE = FuncProcIdOffset + 137
	FuncProcIdScrollToCursor                      FuncProcIdE = FuncProcIdOffset + 138
	FuncProcIdScrollingTexture                    FuncProcIdE = FuncProcIdOffset + 139
	FuncProcIdScrollingTextureRelease             FuncProcIdE = FuncProcIdOffset + 140
	FuncProcIdSelectableLabel                     FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdSeparator                           FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdSetAnimationFreeze                  FuncProcIdE = FuncProcIdOffset + 143
	FuncProcIdSetIdsDensity                       FuncProcIdE = FuncProcIdOffset + 144
	FuncProcIdSetVideoPipeline                    FuncProcIdE = FuncProcIdOffset + 145
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 146
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 147
	FuncProcIdSliderF64                           FuncProcIdE = FuncProcIdOffset + 148
	FuncProcIdSliderI64                           FuncProcIdE = FuncProcIdOffset + 149
	FuncProcIdSliderU64                           FuncProcIdE = FuncProcIdOffset + 150
	FuncProcIdSpinner                             FuncProcIdE = FuncProcIdOffset + 151
	FuncProcIdStyledSections                      FuncProcIdE = FuncProcIdOffset + 152
	FuncProcIdSurrenderFocus                      FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdTable                               FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdTableCellRichText                   FuncProcIdE = FuncProcIdOffset + 155
	FuncProcIdTableCellText                       FuncProcIdE = FuncProcIdOffset + 156
	FuncProcIdTableColumn                         FuncProcIdE = FuncProcIdOffset + 157
	FuncProcIdTableHeaderText                     FuncProcIdE = FuncProcIdOffset + 158
	FuncProcIdTextEdit                            FuncProcIdE = FuncProcIdOffset + 159
	FuncProcIdTimeRangePicker                     FuncProcIdE = FuncProcIdOffset + 160
	FuncProcIdTintedScope                         FuncProcIdE = FuncProcIdOffset + 161
	FuncProcIdUiClipToMaxRect                     FuncProcIdE = FuncProcIdOffset + 162
	FuncProcIdUiDisable                           FuncProcIdE = FuncProcIdOffset + 163
	FuncProcIdUiSetHeight                         FuncProcIdE = FuncProcIdOffset + 164
	FuncProcIdUiSetItemSpacing                    FuncProcIdE = FuncProcIdOffset + 165
	FuncProcIdUiSetMaxHeight                      FuncProcIdE = FuncProcIdOffset + 166
	FuncProcIdUiSetMaxWidth                       FuncProcIdE = FuncProcIdOffset + 167
	FuncProcIdUiSetMinHeight                      FuncProcIdE = FuncProcIdOffset + 168
	FuncProcIdUiSetMinWidth                       FuncProcIdE = FuncProcIdOffset + 169
	FuncProcIdUiSetMinWidthAvailable              FuncProcIdE = FuncProcIdOffset + 170
	FuncProcIdUiSetWidth                          FuncProcIdE = FuncProcIdOffset + 171
	FuncProcIdUiWithLayout                        FuncProcIdE = FuncProcIdOffset + 172
	FuncProcIdVectorSize                          FuncProcIdE = FuncProcIdOffset + 173
	FuncProcIdVertical                            FuncProcIdE = FuncProcIdOffset + 174
	FuncProcIdVerticalCentered                    FuncProcIdE = FuncProcIdOffset + 175
	FuncProcIdVerticalCenteredJustified           FuncProcIdE = FuncProcIdOffset + 176
	FuncProcIdWarnIfDebugBuild                    FuncProcIdE = FuncProcIdOffset + 177
	FuncProcIdWidgetText                          FuncProcIdE = FuncProcIdOffset + 178
	FuncProcIdWidgetsGlobalThemePreferenceButtons FuncProcIdE = FuncProcIdOffset + 179
	FuncProcIdWindow                              FuncProcIdE = FuncProcIdOffset + 180
)
const (
...
const (
	PaintSegmentsMethodIdBuild PaintSegmentsMethodIdE = 0

	PaintSegmentsMethodIdTessellated PaintSegmentsMethodIdE = 1
)
...
const (
	...
	TextEditMethodIdCaptureKeys    TextEditMethodIdE = 19
)
