...
const (
	...
	FuncProcIdContextMenu                         FuncProcIdE = FuncProcIdOffset + 16
	FuncProcIdContextSendViewPortCommandClose     FuncProcIdE = FuncProcIdOffset + 17
	FuncProcIdCopyTextToClipboard                 FuncProcIdE = FuncProcIdOffset + 18
	FuncProcIdDatePickerButton                    FuncProcIdE = FuncProcIdOffset + 19
	FuncProcIdDateTimePickerButton                FuncProcIdE = FuncProcIdOffset + 20
	FuncProcIdDockAreaRaw                         FuncProcIdE = FuncProcIdOffset + 21
	FuncProcIdDragValueF64                        FuncProcIdE = FuncProcIdOffset + 22
	FuncProcIdDragValueI64                        FuncProcIdE = FuncProcIdOffset + 23
	FuncProcIdDragValueU64                        FuncProcIdE = FuncProcIdOffset + 24
	FuncProcIdEnabledUi                           FuncProcIdE = FuncProcIdOffset + 25
	FuncProcIdEnd                                 FuncProcIdE = FuncProcIdOffset + 26
	FuncProcIdEndETable                           FuncProcIdE = FuncProcIdOffset + 27
	FuncProcIdEndRow                              FuncProcIdE = FuncProcIdOffset + 28
	FuncProcIdEtColumn                            FuncProcIdE = FuncProcIdOffset + 29
	FuncProcIdEtHeaderText                        FuncProcIdE = FuncProcIdOffset + 30
	FuncProcIdEtRowHeight                         FuncProcIdE = FuncProcIdOffset + 31
	FuncProcIdExportSvg                           FuncProcIdE = FuncProcIdOffset + 32
	FuncProcIdExportSvgWindow                     FuncProcIdE = FuncProcIdOffset + 33
	FuncProcIdFetchCommandEnterPressed            FuncProcIdE = FuncProcIdOffset + 34
	FuncProcIdFetchF1KeyPressed                   FuncProcIdE = FuncProcIdOffset + 35
	FuncProcIdFetchFrameMetrics                   FuncProcIdE = FuncProcIdOffset + 36
	FuncProcIdFetchGraphEvents                    FuncProcIdE = FuncProcIdOffset + 37
	FuncProcIdFetchGraphMetrics                   FuncProcIdE = FuncProcIdOffset + 38
	FuncProcIdFetchGraphSelection                 FuncProcIdE = FuncProcIdOffset + 39
	FuncProcIdFetchR10                            FuncProcIdE = FuncProcIdOffset + 40
	FuncProcIdFetchR14CanvasPointer               FuncProcIdE = FuncProcIdOffset + 41
