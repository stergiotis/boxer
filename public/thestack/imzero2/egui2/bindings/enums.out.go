...
const (
	...
	FuncProcIdFetchR7                             FuncProcIdE = FuncProcIdOffset + 50
	FuncProcIdFetchR9EtPrefetch                   FuncProcIdE = FuncProcIdOffset + 51
	FuncProcIdFetchR9F64                          FuncProcIdE = FuncProcIdOffset + 52
	FuncProcIdFetchR9I64                          FuncProcIdE = FuncProcIdOffset + 53
	FuncProcIdFetchR9S                            FuncProcIdE = FuncProcIdOffset + 54
	FuncProcIdFetchR9U64                          FuncProcIdE = FuncProcIdOffset + 55
	FuncProcIdFetchSnarlEvents                    FuncProcIdE = FuncProcIdOffset + 56
	FuncProcIdFetchVideoCapabilities              FuncProcIdE = FuncProcIdOffset + 57
	FuncProcIdFetchVideoStreamInfo                FuncProcIdE = FuncProcIdOffset + 58
	FuncProcIdFrame                               FuncProcIdE = FuncProcIdOffset + 59
	FuncProcIdGraph                               FuncProcIdE = FuncProcIdOffset + 60
	FuncProcIdGraphEdge                           FuncProcIdE = FuncProcIdOffset + 61
	FuncProcIdGraphNode                           FuncProcIdE = FuncProcIdOffset + 62
	FuncProcIdGrid                                FuncProcIdE = FuncProcIdOffset + 63
	FuncProcIdGroup                               FuncProcIdE = FuncProcIdOffset + 64
	FuncProcIdGuiZoomZoomMenuButtons              FuncProcIdE = FuncProcIdOffset + 65
	FuncProcIdH3CellsColored                      FuncProcIdE = FuncProcIdOffset + 66
	FuncProcIdH3Region                            FuncProcIdE = FuncProcIdOffset + 67
	...
	FuncProcIdMapMarker                           FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMapPolyline                         FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMapRaster                           FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdMeasureText                         FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdMeasureTextSize                     FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 90
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 91
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 92
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 93
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 94
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 95
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 96
	...
	FuncProcIdPaintCubicBezier                    FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintDashedLine                     FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPaintEllipseFilled                  FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPaintEllipseStroke                  FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 106
	...
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 128
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 129
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 130
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 131
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 132
	FuncProcIdPrepareNextFrame                    FuncProcIdE = FuncProcIdOffset + 133
	FuncProcIdProgressBar                         FuncProcIdE = FuncProcIdOffset + 134
	FuncProcIdPushId                              FuncProcIdE = FuncProcIdOffset + 135
	FuncProcIdRadioButton                         FuncProcIdE = FuncProcIdOffset + 136
	FuncProcIdRequestRepaint                      FuncProcIdE = FuncProcIdOffset + 137
	FuncProcIdRequestRepaintAfter                 FuncProcIdE = FuncProcIdOffset + 138
	FuncProcIdRequestScreenshot                   FuncProcIdE = FuncProcIdOffset + 139
	FuncProcIdRequestScreenshotRect               FuncProcIdE = FuncProcIdOffset + 140
	FuncProcIdScalarSize                          FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdScope                               FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdScrollArea                          FuncProcIdE = FuncProcIdOffset + 143
	FuncProcIdScrollToCursor                      FuncProcIdE = FuncProcIdOffset + 144
	FuncProcIdScrollingTexture                    FuncProcIdE = FuncProcIdOffset + 145
	FuncProcIdScrollingTextureRelease             FuncProcIdE = FuncProcIdOffset + 146
	FuncProcIdSelectableLabel                     FuncProcIdE = FuncProcIdOffset + 147
	FuncProcIdSeparator                           FuncProcIdE = FuncProcIdOffset + 148
	FuncProcIdSetAnimationFreeze                  FuncProcIdE = FuncProcIdOffset + 149
	FuncProcIdSetVideoPipeline                    FuncProcIdE = FuncProcIdOffset + 150
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 151
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 152
	FuncProcIdShowPuffinProfiler                  FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdSliderF64                           FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdSliderI64                           FuncProcIdE = FuncProcIdOffset + 155
	FuncProcIdSliderU64                           FuncProcIdE = FuncProcIdOffset + 156
	FuncProcIdSnarlConnection                     FuncProcIdE = FuncProcIdOffset + 157
	FuncProcIdSnarlEditor                         FuncProcIdE = FuncProcIdOffset + 158
