...
const (
	...
	FuncProcIdMapRaster                           FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMeasureText                         FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMeasureTextSize                     FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 90
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 91
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 92
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 93
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 94
	FuncProcIdPaintAbsoluteOverlay                FuncProcIdE = FuncProcIdOffset + 95
	FuncProcIdPaintArrow                          FuncProcIdE = FuncProcIdOffset + 96
	FuncProcIdPaintCanvas                         FuncProcIdE = FuncProcIdOffset + 97
	FuncProcIdPaintCircleFilled                   FuncProcIdE = FuncProcIdOffset + 98
	FuncProcIdPaintCircleStroke                   FuncProcIdE = FuncProcIdOffset + 99
	...
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 104
	...
	FuncProcIdPaintSenseRegion                    FuncProcIdE = FuncProcIdOffset + 109
	FuncProcIdPaintText                           FuncProcIdE = FuncProcIdOffset + 110
	FuncProcIdPanelBottom                         FuncProcIdE = FuncProcIdOffset + 111
	FuncProcIdPanelBottomInside                   FuncProcIdE = FuncProcIdOffset + 112
	FuncProcIdPanelCentral                        FuncProcIdE = FuncProcIdOffset + 113
	FuncProcIdPanelCentralInside                  FuncProcIdE = FuncProcIdOffset + 114
	FuncProcIdPanelLeft                           FuncProcIdE = FuncProcIdOffset + 115
	FuncProcIdPanelLeftInside                     FuncProcIdE = FuncProcIdOffset + 116
	FuncProcIdPanelRight                          FuncProcIdE = FuncProcIdOffset + 117
	FuncProcIdPanelRightInside                    FuncProcIdE = FuncProcIdOffset + 118
	FuncProcIdPanelTop                            FuncProcIdE = FuncProcIdOffset + 119
	FuncProcIdPanelTopInside                      FuncProcIdE = FuncProcIdOffset + 120
	FuncProcIdPassthrough                         FuncProcIdE = FuncProcIdOffset + 121
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 122
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 128
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 129
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 130
	FuncProcIdPrepareNextFrame                    FuncProcIdE = FuncProcIdOffset + 131
	FuncProcIdProgressBar                         FuncProcIdE = FuncProcIdOffset + 132
	FuncProcIdPushId                              FuncProcIdE = FuncProcIdOffset + 133
	FuncProcIdRadioButton                         FuncProcIdE = FuncProcIdOffset + 134
	FuncProcIdRequestRepaint                      FuncProcIdE = FuncProcIdOffset + 135
	FuncProcIdRequestRepaintAfter                 FuncProcIdE = FuncProcIdOffset + 136
	FuncProcIdRequestScreenshot                   FuncProcIdE = FuncProcIdOffset + 137
	FuncProcIdRequestScreenshotRect               FuncProcIdE = FuncProcIdOffset + 138
	FuncProcIdScalarSize                          FuncProcIdE = FuncProcIdOffset + 139
	FuncProcIdScope                               FuncProcIdE = FuncProcIdOffset + 140
	FuncProcIdScrollArea                          FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdScrollToCursor                      FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdScrollingTexture                    FuncProcIdE = FuncProcIdOffset + 143
	FuncProcIdScrollingTextureRelease             FuncProcIdE = FuncProcIdOffset + 144
	FuncProcIdSelectableLabel                     FuncProcIdE = FuncProcIdOffset + 145
	FuncProcIdSeparator                           FuncProcIdE = FuncProcIdOffset + 146
	FuncProcIdSetAnimationFreeze                  FuncProcIdE = FuncProcIdOffset + 147
	FuncProcIdSetVideoPipeline                    FuncProcIdE = FuncProcIdOffset + 148
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 149
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 150
	FuncProcIdShowPuffinProfiler                  FuncProcIdE = FuncProcIdOffset + 151
	FuncProcIdSliderF64                           FuncProcIdE = FuncProcIdOffset + 152
	FuncProcIdSliderI64                           FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdSliderU64                           FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdSnarlConnection                     FuncProcIdE = FuncProcIdOffset + 155
	FuncProcIdSnarlEditor                         FuncProcIdE = FuncProcIdOffset + 156
	FuncProcIdSnarlNode                           FuncProcIdE = FuncProcIdOffset + 157
	FuncProcIdSnarlPin                            FuncProcIdE = FuncProcIdOffset + 158
	FuncProcIdSpinner                             FuncProcIdE = FuncProcIdOffset + 159
	FuncProcIdTable                               FuncProcIdE = FuncProcIdOffset + 160
	FuncProcIdTableCellRichText                   FuncProcIdE = FuncProcIdOffset + 161
	FuncProcIdTableCellText                       FuncProcIdE = FuncProcIdOffset + 162
	FuncProcIdTableColumn                         FuncProcIdE = FuncProcIdOffset + 163
	FuncProcIdTableHeaderText                     FuncProcIdE = FuncProcIdOffset + 164
	FuncProcIdTextEdit                            FuncProcIdE = FuncProcIdOffset + 165
	FuncProcIdTimeRangePicker                     FuncProcIdE = FuncProcIdOffset + 166
	FuncProcIdTintedScope                         FuncProcIdE = FuncProcIdOffset + 167
	FuncProcIdTree                                FuncProcIdE = FuncProcIdOffset + 168
	FuncProcIdUiClipToMaxRect                     FuncProcIdE = FuncProcIdOffset + 169
	FuncProcIdUiDisable                           FuncProcIdE = FuncProcIdOffset + 170
	FuncProcIdUiSetHeight                         FuncProcIdE = FuncProcIdOffset + 171
	FuncProcIdUiSetMaxHeight                      FuncProcIdE = FuncProcIdOffset + 172
	FuncProcIdUiSetMaxWidth                       FuncProcIdE = FuncProcIdOffset + 173
	FuncProcIdUiSetMinHeight                      FuncProcIdE = FuncProcIdOffset + 174
	FuncProcIdUiSetMinWidth                       FuncProcIdE = FuncProcIdOffset + 175
	FuncProcIdUiSetWidth                          FuncProcIdE = FuncProcIdOffset + 176
	FuncProcIdUiWithLayout                        FuncProcIdE = FuncProcIdOffset + 177
	FuncProcIdVectorSize                          FuncProcIdE = FuncProcIdOffset + 178
	FuncProcIdVertical                            FuncProcIdE = FuncProcIdOffset + 179
	FuncProcIdVerticalCentered                    FuncProcIdE = FuncProcIdOffset + 180
	FuncProcIdVerticalCenteredJustified           FuncProcIdE = FuncProcIdOffset + 181
	FuncProcIdWalkersMap                          FuncProcIdE = FuncProcIdOffset + 182
	FuncProcIdWarnIfDebugBuild                    FuncProcIdE = FuncProcIdOffset + 183
	FuncProcIdWidgetText                          FuncProcIdE = FuncProcIdOffset + 184
	FuncProcIdWidgetsGlobalThemePreferenceButtons FuncProcIdE = FuncProcIdOffset + 185
	FuncProcIdWindow                              FuncProcIdE = FuncProcIdOffset + 186
)
const (
