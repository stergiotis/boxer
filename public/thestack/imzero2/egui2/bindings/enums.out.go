...
const (
	...
	FuncProcIdFrame                               FuncProcIdE = FuncProcIdOffset + 55
	FuncProcIdGraph                               FuncProcIdE = FuncProcIdOffset + 56
	FuncProcIdGraphEdge                           FuncProcIdE = FuncProcIdOffset + 57
	FuncProcIdGraphNode                           FuncProcIdE = FuncProcIdOffset + 58
	FuncProcIdGrid                                FuncProcIdE = FuncProcIdOffset + 59
	FuncProcIdGroup                               FuncProcIdE = FuncProcIdOffset + 60
	FuncProcIdGuiZoomZoomMenuButtons              FuncProcIdE = FuncProcIdOffset + 61
	FuncProcIdH3CellsColored                      FuncProcIdE = FuncProcIdOffset + 62
	FuncProcIdH3Region                            FuncProcIdE = FuncProcIdOffset + 63
	FuncProcIdHorizontal                          FuncProcIdE = FuncProcIdOffset + 64
	FuncProcIdHorizontalCentered                  FuncProcIdE = FuncProcIdOffset + 65
	FuncProcIdHorizontalTop                       FuncProcIdE = FuncProcIdOffset + 66
	FuncProcIdHorizontalWrapped                   FuncProcIdE = FuncProcIdOffset + 67
	FuncProcIdHoverText                           FuncProcIdE = FuncProcIdOffset + 68
	FuncProcIdHoverUi                             FuncProcIdE = FuncProcIdOffset + 69
	FuncProcIdHyperlink                           FuncProcIdE = FuncProcIdOffset + 70
	FuncProcIdHyperlinkTo                         FuncProcIdE = FuncProcIdOffset + 71
	FuncProcIdImage                               FuncProcIdE = FuncProcIdOffset + 72
	FuncProcIdImageRelease                        FuncProcIdE = FuncProcIdOffset + 73
	FuncProcIdIndent                              FuncProcIdE = FuncProcIdOffset + 74
	FuncProcIdLabel                               FuncProcIdE = FuncProcIdOffset + 75
	FuncProcIdLabelAtoms                          FuncProcIdE = FuncProcIdOffset + 76
	FuncProcIdLabelWidgetText                     FuncProcIdE = FuncProcIdOffset + 77
	FuncProcIdMapMarker                           FuncProcIdE = FuncProcIdOffset + 78
	FuncProcIdMapPolyline                         FuncProcIdE = FuncProcIdOffset + 79
	FuncProcIdMeasureText                         FuncProcIdE = FuncProcIdOffset + 80
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 81
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 90
	...
	FuncProcIdPaintCubicBezier                    FuncProcIdE = FuncProcIdOffset + 96
	FuncProcIdPaintDashedLine                     FuncProcIdE = FuncProcIdOffset + 97
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 98
	FuncProcIdPaintPolyline                       FuncProcIdE = FuncProcIdOffset + 99
	FuncProcIdPaintRectFilled                     FuncProcIdE = FuncProcIdOffset + 100
	FuncProcIdPaintRectStroke                     FuncProcIdE = FuncProcIdOffset + 101
	FuncProcIdPaintSenseRegion                    FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintText                           FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPanelBottom                         FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPanelBottomInside                   FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPanelCentral                        FuncProcIdE = FuncProcIdOffset + 106
	FuncProcIdPanelCentralInside                  FuncProcIdE = FuncProcIdOffset + 107
	FuncProcIdPanelLeft                           FuncProcIdE = FuncProcIdOffset + 108
	FuncProcIdPanelLeftInside                     FuncProcIdE = FuncProcIdOffset + 109
	FuncProcIdPanelRight                          FuncProcIdE = FuncProcIdOffset + 110
	FuncProcIdPanelRightInside                    FuncProcIdE = FuncProcIdOffset + 111
	FuncProcIdPanelTop                            FuncProcIdE = FuncProcIdOffset + 112
	FuncProcIdPanelTopInside                      FuncProcIdE = FuncProcIdOffset + 113
	FuncProcIdPassthrough                         FuncProcIdE = FuncProcIdOffset + 114
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 115
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 116
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 117
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 118
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 119
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 120
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 121
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 122
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPrepareNextFrame                    FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdProgressBar                         FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPushId                              FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdRadioButton                         FuncProcIdE = FuncProcIdOffset + 127
	...
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdShowPuffinProfiler                  FuncProcIdE = FuncProcIdOffset + 143
	...
	FuncProcIdSnarlConnection                     FuncProcIdE = FuncProcIdOffset + 147
	FuncProcIdSnarlEditor                         FuncProcIdE = FuncProcIdOffset + 148
	FuncProcIdSnarlNode                           FuncProcIdE = FuncProcIdOffset + 149
	FuncProcIdSnarlPin                            FuncProcIdE = FuncProcIdOffset + 150
	FuncProcIdSpinner                             FuncProcIdE = FuncProcIdOffset + 151
	FuncProcIdTable                               FuncProcIdE = FuncProcIdOffset + 152
	FuncProcIdTableCellRichText                   FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdTableCellText                       FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdTableColumn                         FuncProcIdE = FuncProcIdOffset + 155
	FuncProcIdTableHeaderText                     FuncProcIdE = FuncProcIdOffset + 156
	FuncProcIdTextEdit                            FuncProcIdE = FuncProcIdOffset + 157
	FuncProcIdTimeRangePicker                     FuncProcIdE = FuncProcIdOffset + 158
	FuncProcIdTintedScope                         FuncProcIdE = FuncProcIdOffset + 159
	FuncProcIdTree                                FuncProcIdE = FuncProcIdOffset + 160
	FuncProcIdUiDisable                           FuncProcIdE = FuncProcIdOffset + 161
	FuncProcIdUiSetHeight                         FuncProcIdE = FuncProcIdOffset + 162
	...
	FuncProcIdWalkersMap                          FuncProcIdE = FuncProcIdOffset + 173
