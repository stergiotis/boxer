...
const (
	...
	FuncProcIdFrame                               FuncProcIdE = FuncProcIdOffset + 56
	FuncProcIdGraph                               FuncProcIdE = FuncProcIdOffset + 57
	FuncProcIdGraphEdge                           FuncProcIdE = FuncProcIdOffset + 58
	FuncProcIdGraphNode                           FuncProcIdE = FuncProcIdOffset + 59
	FuncProcIdGrid                                FuncProcIdE = FuncProcIdOffset + 60
	FuncProcIdGroup                               FuncProcIdE = FuncProcIdOffset + 61
	FuncProcIdGuiZoomZoomMenuButtons              FuncProcIdE = FuncProcIdOffset + 62
	FuncProcIdH3CellsColored                      FuncProcIdE = FuncProcIdOffset + 63
	FuncProcIdH3Region                            FuncProcIdE = FuncProcIdOffset + 64
	FuncProcIdHorizontal                          FuncProcIdE = FuncProcIdOffset + 65
	FuncProcIdHorizontalCentered                  FuncProcIdE = FuncProcIdOffset + 66
	FuncProcIdHorizontalTop                       FuncProcIdE = FuncProcIdOffset + 67
	FuncProcIdHorizontalWrapped                   FuncProcIdE = FuncProcIdOffset + 68
	FuncProcIdHoverText                           FuncProcIdE = FuncProcIdOffset + 69
	FuncProcIdHoverUi                             FuncProcIdE = FuncProcIdOffset + 70
	FuncProcIdHyperlink                           FuncProcIdE = FuncProcIdOffset + 71
	FuncProcIdHyperlinkTo                         FuncProcIdE = FuncProcIdOffset + 72
	FuncProcIdImage                               FuncProcIdE = FuncProcIdOffset + 73
	FuncProcIdImageRelease                        FuncProcIdE = FuncProcIdOffset + 74
	FuncProcIdIndent                              FuncProcIdE = FuncProcIdOffset + 75
	FuncProcIdLabel                               FuncProcIdE = FuncProcIdOffset + 76
	FuncProcIdLabelAtoms                          FuncProcIdE = FuncProcIdOffset + 77
	FuncProcIdLabelWidgetText                     FuncProcIdE = FuncProcIdOffset + 78
	FuncProcIdMapMarker                           FuncProcIdE = FuncProcIdOffset + 79
	FuncProcIdMapPolyline                         FuncProcIdE = FuncProcIdOffset + 80
	FuncProcIdMeasureText                         FuncProcIdE = FuncProcIdOffset + 81
	FuncProcIdMeasureTextSize                     FuncProcIdE = FuncProcIdOffset + 82
	FuncProcIdMemoryResetAreas                    FuncProcIdE = FuncProcIdOffset + 83
	FuncProcIdMenuBar                             FuncProcIdE = FuncProcIdOffset + 84
	FuncProcIdMenuButton                          FuncProcIdE = FuncProcIdOffset + 85
	FuncProcIdMoveWindowToTop                     FuncProcIdE = FuncProcIdOffset + 86
	FuncProcIdNewTable                            FuncProcIdE = FuncProcIdOffset + 87
	FuncProcIdNewTableColumn                      FuncProcIdE = FuncProcIdOffset + 88
	FuncProcIdNewTableRowHeight                   FuncProcIdE = FuncProcIdOffset + 89
	FuncProcIdNodeDir                             FuncProcIdE = FuncProcIdOffset + 90
	FuncProcIdNodeDirClose                        FuncProcIdE = FuncProcIdOffset + 91
	FuncProcIdNodeLeaf                            FuncProcIdE = FuncProcIdOffset + 92
	...
	FuncProcIdPaintLine                           FuncProcIdE = FuncProcIdOffset + 102
	FuncProcIdPaintPolygonFilled                  FuncProcIdE = FuncProcIdOffset + 103
	FuncProcIdPaintPolyline                       FuncProcIdE = FuncProcIdOffset + 104
	FuncProcIdPaintRectFilled                     FuncProcIdE = FuncProcIdOffset + 105
	FuncProcIdPaintRectStroke                     FuncProcIdE = FuncProcIdOffset + 106
	FuncProcIdPaintSenseRegion                    FuncProcIdE = FuncProcIdOffset + 107
	FuncProcIdPaintText                           FuncProcIdE = FuncProcIdOffset + 108
	FuncProcIdPanelBottom                         FuncProcIdE = FuncProcIdOffset + 109
	FuncProcIdPanelBottomInside                   FuncProcIdE = FuncProcIdOffset + 110
	FuncProcIdPanelCentral                        FuncProcIdE = FuncProcIdOffset + 111
	FuncProcIdPanelCentralInside                  FuncProcIdE = FuncProcIdOffset + 112
	FuncProcIdPanelLeft                           FuncProcIdE = FuncProcIdOffset + 113
	FuncProcIdPanelLeftInside                     FuncProcIdE = FuncProcIdOffset + 114
	FuncProcIdPanelRight                          FuncProcIdE = FuncProcIdOffset + 115
	FuncProcIdPanelRightInside                    FuncProcIdE = FuncProcIdOffset + 116
	FuncProcIdPanelTop                            FuncProcIdE = FuncProcIdOffset + 117
	FuncProcIdPanelTopInside                      FuncProcIdE = FuncProcIdOffset + 118
	FuncProcIdPassthrough                         FuncProcIdE = FuncProcIdOffset + 119
	FuncProcIdPlot                                FuncProcIdE = FuncProcIdOffset + 120
	FuncProcIdPlotBars                            FuncProcIdE = FuncProcIdOffset + 121
	FuncProcIdPlotBoxes                           FuncProcIdE = FuncProcIdOffset + 122
	FuncProcIdPlotHLine                           FuncProcIdE = FuncProcIdOffset + 123
	FuncProcIdPlotLine                            FuncProcIdE = FuncProcIdOffset + 124
	FuncProcIdPlotPolygon                         FuncProcIdE = FuncProcIdOffset + 125
	FuncProcIdPlotScatter                         FuncProcIdE = FuncProcIdOffset + 126
	FuncProcIdPlotText                            FuncProcIdE = FuncProcIdOffset + 127
	FuncProcIdPlotVLine                           FuncProcIdE = FuncProcIdOffset + 128
	...
	FuncProcIdRequestRepaint                      FuncProcIdE = FuncProcIdOffset + 133
	FuncProcIdRequestRepaintAfter                 FuncProcIdE = FuncProcIdOffset + 134
	FuncProcIdRequestScreenshot                   FuncProcIdE = FuncProcIdOffset + 135
	FuncProcIdRequestScreenshotRect               FuncProcIdE = FuncProcIdOffset + 136
	FuncProcIdScalarSize                          FuncProcIdE = FuncProcIdOffset + 137
	FuncProcIdScope                               FuncProcIdE = FuncProcIdOffset + 138
	FuncProcIdScrollArea                          FuncProcIdE = FuncProcIdOffset + 139
	FuncProcIdScrollToCursor                      FuncProcIdE = FuncProcIdOffset + 140
	FuncProcIdScrollingTexture                    FuncProcIdE = FuncProcIdOffset + 141
	FuncProcIdScrollingTextureRelease             FuncProcIdE = FuncProcIdOffset + 142
	FuncProcIdSelectableLabel                     FuncProcIdE = FuncProcIdOffset + 143
	FuncProcIdSeparator                           FuncProcIdE = FuncProcIdOffset + 144
	FuncProcIdSetAnimationFreeze                  FuncProcIdE = FuncProcIdOffset + 145
	FuncProcIdSetVideoPipeline                    FuncProcIdE = FuncProcIdOffset + 146
	FuncProcIdSetWindowCollapsed                  FuncProcIdE = FuncProcIdOffset + 147
	FuncProcIdShowDebugTools                      FuncProcIdE = FuncProcIdOffset + 148
	FuncProcIdShowPuffinProfiler                  FuncProcIdE = FuncProcIdOffset + 149
	...
	FuncProcIdSnarlConnection                     FuncProcIdE = FuncProcIdOffset + 153
	FuncProcIdSnarlEditor                         FuncProcIdE = FuncProcIdOffset + 154
	FuncProcIdSnarlNode                           FuncProcIdE = FuncProcIdOffset + 155
	FuncProcIdSnarlPin                            FuncProcIdE = FuncProcIdOffset + 156
	FuncProcIdSpinner                             FuncProcIdE = FuncProcIdOffset + 157
	FuncProcIdTable                               FuncProcIdE = FuncProcIdOffset + 158
	FuncProcIdTableCellRichText                   FuncProcIdE = FuncProcIdOffset + 159
	FuncProcIdTableCellText                       FuncProcIdE = FuncProcIdOffset + 160
	FuncProcIdTableColumn                         FuncProcIdE = FuncProcIdOffset + 161
	FuncProcIdTableHeaderText                     FuncProcIdE = FuncProcIdOffset + 162
	FuncProcIdTextEdit                            FuncProcIdE = FuncProcIdOffset + 163
	FuncProcIdTimeRangePicker                     FuncProcIdE = FuncProcIdOffset + 164
	FuncProcIdTintedScope                         FuncProcIdE = FuncProcIdOffset + 165
	FuncProcIdTree                                FuncProcIdE = FuncProcIdOffset + 166
	FuncProcIdUiClipToMaxRect                     FuncProcIdE = FuncProcIdOffset + 167
	FuncProcIdUiDisable                           FuncProcIdE = FuncProcIdOffset + 168
	FuncProcIdUiSetHeight                         FuncProcIdE = FuncProcIdOffset + 169
	FuncProcIdUiSetMaxHeight                      FuncProcIdE = FuncProcIdOffset + 170
	FuncProcIdUiSetMaxWidth                       FuncProcIdE = FuncProcIdOffset + 171
	FuncProcIdUiSetMinHeight                      FuncProcIdE = FuncProcIdOffset + 172
	FuncProcIdUiSetMinWidth                       FuncProcIdE = FuncProcIdOffset + 173
	FuncProcIdUiSetWidth                          FuncProcIdE = FuncProcIdOffset + 174
	FuncProcIdUiWithLayout                        FuncProcIdE = FuncProcIdOffset + 175
	FuncProcIdVectorSize                          FuncProcIdE = FuncProcIdOffset + 176
	FuncProcIdVertical                            FuncProcIdE = FuncProcIdOffset + 177
	FuncProcIdVerticalCentered                    FuncProcIdE = FuncProcIdOffset + 178
	FuncProcIdVerticalCenteredJustified           FuncProcIdE = FuncProcIdOffset + 179
	FuncProcIdWalkersMap                          FuncProcIdE = FuncProcIdOffset + 180
	FuncProcIdWarnIfDebugBuild                    FuncProcIdE = FuncProcIdOffset + 181
	FuncProcIdWidgetText                          FuncProcIdE = FuncProcIdOffset + 182
	FuncProcIdWidgetsGlobalThemePreferenceButtons FuncProcIdE = FuncProcIdOffset + 183
	FuncProcIdWindow                              FuncProcIdE = FuncProcIdOffset + 184
)
const (
