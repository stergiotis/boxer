...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityModifySystemState, packageprops.CapabilityExec),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/thestack/imzero2/egui2/demo/carousel", PackageProps)
}
