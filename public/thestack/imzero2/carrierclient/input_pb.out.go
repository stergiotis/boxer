...
func (x *InputEvent) GetFocus() *Focus {
	if x != nil {
		if x, ok := x.Event.(*InputEvent_Focus); ok {
			return x.Focus
		}
	}
	return nil
...
type InputEvent_Focus struct {
	// ADR-0242 SD2: the remote input surface gained or lost keyboard focus.
	Focus *Focus `protobuf:"bytes,9,opt,name=focus,proto3,oneof"`
}
...
func (*InputEvent_Focus) isInputEvent_Event() {}
...
type MouseButton struct {
	...
	X     float32                `protobuf:"fixed32,1,opt,name=x,proto3" json:"x,omitempty"`
	Y     float32                `protobuf:"fixed32,2,opt,name=y,proto3" json:"y,omitempty"`
	// 0=primary, 1=secondary, 2=middle, 3=extra1, 4=extra2 — egui::PointerButton
	// order, which is NOT the DOM's: `MouseEvent.button` numbers the auxiliary
	// (middle) button 1 and the secondary 2. The sender translates; these wire
	// numbers are frozen (ADR-0242 SD2) because the host and both existing
	// senders already agree on them.
...
// A keydown/keyup. ADR-0242 SD2: a keydown the host recognises as copy or cut
// (command+C / command+X, or a dedicated Copy/Cut key) is translated into the
// corresponding egui clipboard action instead of a key press, so senders need
// not — and should not — special-case those shortcuts. Paste is the exception:
// contents cannot travel on a keydown, so the sender answers command+V with a
// ClipboardData message and sends the keystroke unchanged.
...
// Client→server (ADR-0242 SD2): keyboard focus of the remote input surface,
// ordered with the other input events so the host can tell which keystrokes
// belong to a focused interval. `false` cancels held keys and buttons instead
// of letting the next release complete a click. The surface is the sender's
// whole input arrangement, not one DOM element: a viewer that moves focus
// between its canvas and a hidden paste trap has not left it and must not
// report a blur. Old senders never send this, and a host that never receives
// it stays focused.
type Focus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VideoChunk) Reset() {
	*x = VideoChunk{}
	mi := &file_boxer_imzero2_v1_input_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VideoChunk) Descriptor() ([]byte, []int) {
	return file_boxer_imzero2_v1_input_proto_rawDescGZIP(), []int{28}
}
...
const file_boxer_imzero2_v1_input_proto_rawDesc = "" +
	"\n" +
	"\x1cboxer/imzero2/v1/input.proto\x12\x10boxer.imzero2.v1\"\xbe\x04\n" +
	"\n" +
	"InputEvent\x12<\n" +
	"\n" +
	...
	"\x10accesskit_action\x18\b \x01(\v2!.boxer.imzero2.v1.AccessKitActionH\x00R\x0faccesskitAction\x12/\n" +
	"\x05focus\x18\t \x01(\v2\x17.boxer.imzero2.v1.FocusH\x00R\x05focusB\a\n" +
	"\x05event\"'\n" +
	"\tMouseMove\x12\f\n" +
...
var file_boxer_imzero2_v1_input_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_boxer_imzero2_v1_input_proto_goTypes = []any{
	...
	(*Focus)(nil),              // 8: boxer.imzero2.v1.Focus
	(*PinchZoom)(nil),          // 9: boxer.imzero2.v1.PinchZoom
	(*AccessKitAction)(nil),    // 10: boxer.imzero2.v1.AccessKitAction
	(*SessionControl)(nil),     // 11: boxer.imzero2.v1.SessionControl
	(*TreeRequest)(nil),        // 12: boxer.imzero2.v1.TreeRequest
	(*TreeSnapshot)(nil),       // 13: boxer.imzero2.v1.TreeSnapshot
	(*TreeNode)(nil),           // 14: boxer.imzero2.v1.TreeNode
	(*CaptureRequest)(nil),     // 15: boxer.imzero2.v1.CaptureRequest
	(*CaptureDone)(nil),        // 16: boxer.imzero2.v1.CaptureDone
	(*CursorShape)(nil),        // 17: boxer.imzero2.v1.CursorShape
	(*ClientHello)(nil),        // 18: boxer.imzero2.v1.ClientHello
	(*RosterEntry)(nil),        // 19: boxer.imzero2.v1.RosterEntry
	(*Roster)(nil),             // 20: boxer.imzero2.v1.Roster
	(*TakeSession)(nil),        // 21: boxer.imzero2.v1.TakeSession
	(*ClipboardData)(nil),      // 22: boxer.imzero2.v1.ClipboardData
	(*DecodeCapabilities)(nil), // 23: boxer.imzero2.v1.DecodeCapabilities
	(*CodecCapability)(nil),    // 24: boxer.imzero2.v1.CodecCapability
	(*SetCadence)(nil),         // 25: boxer.imzero2.v1.SetCadence
	(*SessionHello)(nil),       // 26: boxer.imzero2.v1.SessionHello
	(*ViewportResize)(nil),     // 27: boxer.imzero2.v1.ViewportResize
	(*Ping)(nil),               // 28: boxer.imzero2.v1.Ping
	(*VideoChunk)(nil),         // 29: boxer.imzero2.v1.VideoChunk
}
var file_boxer_imzero2_v1_input_proto_depIdxs = []int32{
	...
	9,  // 6: boxer.imzero2.v1.InputEvent.pinch_zoom:type_name -> boxer.imzero2.v1.PinchZoom
	10, // 7: boxer.imzero2.v1.InputEvent.accesskit_action:type_name -> boxer.imzero2.v1.AccessKitAction
	8,  // 8: boxer.imzero2.v1.InputEvent.focus:type_name -> boxer.imzero2.v1.Focus
	26, // 9: boxer.imzero2.v1.SessionControl.hello:type_name -> boxer.imzero2.v1.SessionHello
	27, // 10: boxer.imzero2.v1.SessionControl.viewport_resize:type_name -> boxer.imzero2.v1.ViewportResize
	28, // 11: boxer.imzero2.v1.SessionControl.ping:type_name -> boxer.imzero2.v1.Ping
	25, // 12: boxer.imzero2.v1.SessionControl.set_cadence:type_name -> boxer.imzero2.v1.SetCadence
	23, // 13: boxer.imzero2.v1.SessionControl.decode_capabilities:type_name -> boxer.imzero2.v1.DecodeCapabilities
	18, // 14: boxer.imzero2.v1.SessionControl.client_hello:type_name -> boxer.imzero2.v1.ClientHello
	20, // 15: boxer.imzero2.v1.SessionControl.roster:type_name -> boxer.imzero2.v1.Roster
	21, // 16: boxer.imzero2.v1.SessionControl.take_session:type_name -> boxer.imzero2.v1.TakeSession
	22, // 17: boxer.imzero2.v1.SessionControl.clipboard:type_name -> boxer.imzero2.v1.ClipboardData
	17, // 18: boxer.imzero2.v1.SessionControl.cursor_shape:type_name -> boxer.imzero2.v1.CursorShape
	12, // 19: boxer.imzero2.v1.SessionControl.tree_request:type_name -> boxer.imzero2.v1.TreeRequest
	13, // 20: boxer.imzero2.v1.SessionControl.tree_snapshot:type_name -> boxer.imzero2.v1.TreeSnapshot
	15, // 21: boxer.imzero2.v1.SessionControl.capture_request:type_name -> boxer.imzero2.v1.CaptureRequest
	16, // 22: boxer.imzero2.v1.SessionControl.capture_done:type_name -> boxer.imzero2.v1.CaptureDone
	14, // 23: boxer.imzero2.v1.TreeSnapshot.nodes:type_name -> boxer.imzero2.v1.TreeNode
	0,  // 24: boxer.imzero2.v1.RosterEntry.role:type_name -> boxer.imzero2.v1.Role
	0,  // 25: boxer.imzero2.v1.Roster.you_role:type_name -> boxer.imzero2.v1.Role
	19, // 26: boxer.imzero2.v1.Roster.connections:type_name -> boxer.imzero2.v1.RosterEntry
	24, // 27: boxer.imzero2.v1.DecodeCapabilities.codecs:type_name -> boxer.imzero2.v1.CodecCapability
...
func file_boxer_imzero2_v1_input_proto_init() {
	...
	file_boxer_imzero2_v1_input_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*InputEvent_Focus)(nil),
	}
	file_boxer_imzero2_v1_input_proto_msgTypes[10].OneofWrappers = []any{
