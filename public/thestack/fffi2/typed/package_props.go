...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityNetwork, packageprops.CapabilityRuntime, packageprops.CapabilitySystemCalls, packageprops.CapabilityUnsafePointer),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/thestack/fffi2/typed", PackageProps)
}
