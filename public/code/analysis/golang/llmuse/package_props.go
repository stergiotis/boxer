...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityOperatingSystem),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/code/analysis/golang/llmuse", PackageProps)
}
