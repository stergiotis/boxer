...
func TestLeafSeed(t *testing.T) {
	cases := []struct {
		...
		{"json v2 on the same reflect subset", "encoding/json/v2", godep.ClassStdlib, TargetWASI, TierYellow, ReasonReflect},
		{"jsontext on the same reflect subset", "encoding/json/jsontext", godep.ClassStdlib, TargetWASI, TierYellow, ReasonReflect},
