...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityReadSystemState, packageprops.CapabilityModifySystemState),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/code/analysis/golang/wasmsurvey", PackageProps)
}
