...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityArbitraryExecution),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/streaming/persisted/kafka/cli", PackageProps)
}
