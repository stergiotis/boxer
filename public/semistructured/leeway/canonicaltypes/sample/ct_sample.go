...
var SampleScalarModifier = []canonicaltypes2.ScalarModifierE{
	canonicaltypes2.ScalarModifierNone,
	canonicaltypes2.ScalarModifierHomogenousArray,
	canonicaltypes2.ScalarModifierSet,
}
...
var sampleTypeU = []uint64{
	SampleMachineNumericMaxExcl,
	SampleStringTypeMaxExcl,
	SampleTemporalTypeMaxExcl,
	SampleNetworkTypeMaxExcl, // Added
}
...
func GenerateSampleType(n uint64) (sample canonicaltypes2.PrimitiveAstNodeI) {
	...
	for i, u := range sampleTypeU {
		if n < u {
			...
			case 3:
				return GenerateSampleNetworkType(n)
			}
		}
		n -= u
	}
...
func GenerateSampleStringType(n uint64) (sample canonicaltypes2.StringAstNode) {
	...
	return canonicaltypes2.StringAstNode{
...
func GenerateSampleNetworkType(n uint64) (sample canonicaltypes2.NetworkTypeAstNode) {
