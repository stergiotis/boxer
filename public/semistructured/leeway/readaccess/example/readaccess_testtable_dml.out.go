...
func CreateSchemaTestTable() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		...
		/* 016 */ arrow.Field{Name: "tv:text:lmv:lmv:y:124:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 017 */ arrow.Field{Name: "tv:text:mvhp:mvhp:y:4:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 018 */ arrow.Field{Name: "tv:text:len:len:u64:4D:::0::", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 019 */ arrow.Field{Name: "tv:text:lrcard:lrcard:u64:4E:::0::", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 020 */ arrow.Field{Name: "tv:text:lmvcard:lmvcard:u64:4E:::0::", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
	}, nil)
	return
}
...
func (inst *InEntityTestTableSectionGeoInAttr) applyAmbientMemberships() {
}
