...
FROM (
  ...
  FROM (
    SELECT
      ...
      raggedParentIds([2,0,1,3]) = [1,1,3,4,4,4] AS a1,
      ...
      LEEWAY_VALUE_BY_TAG_EQUAL(['a','b','c','d'],[10,11,12,13,14,15],10,raggedParentIds([2,0,1,3])) = 'a' AS a6,
      LEEWAY_VALUE_BY_TAG_EQUAL(['a','b','c','d'],[10,11,12,13,14,15],11,raggedParentIds([2,0,1,3])) = 'a' AS a7,
      LEEWAY_VALUE_BY_TAG_EQUAL(['a','b','c','d'],[10,11,12,13,14,15],12,raggedParentIds([2,0,1,3])) = 'c' AS a8,
      LEEWAY_VALUE_BY_TAG_EQUAL(['a','b','c','d'],[10,11,12,13,14,15],15,raggedParentIds([2,0,1,3])) = 'd' AS a9,
      LEEWAY_VALUE_BY_TAG_EQUAL(['a','b','c','d'],[10,11,12,13,14,15],99,raggedParentIds([2,0,1,3])) = '' AS a10,
      LEEWAY_LU_ATTR_BY_TAG([10,11,12,13,14,15],12,raggedParentIds([2,0,1,3])) = 3 AS a11,
      LEEWAY_LU_ATTR_BY_TAG([10,11,12,13,14,15],99,raggedParentIds([2,0,1,3])) = 0 AS a12,
      ...
      raggedParentIds([1,1,1]) = [1,2,3] AS b1,
      raggedNest(['x1','x2','y1','y2','y3','z1'],[2,3,1]) = [['x1','x2'],['y1','y2','y3'],['z1']] AS b2,
      LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','y1','y2','y3','z1'],[2,3,1],[100,200,300],100,raggedParentIds([1,1,1])) = ['x1','x2'] AS b3,
      LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','y1','y2','y3','z1'],[2,3,1],[100,200,300],200,raggedParentIds([1,1,1])) = ['y1','y2','y3'] AS b4,
      LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','y1','y2','y3','z1'],[2,3,1],[100,200,300],300,raggedParentIds([1,1,1])) = ['z1'] AS b5,
      empty(LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','y1','y2','y3','z1'],[2,3,1],[100,200,300],999,raggedParentIds([1,1,1]))) AS b6,
      raggedNest(['x1','x2','z1'],[2,0,1]) = [['x1','x2'],[],['z1']] AS b7,
      empty(LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','z1'],[2,0,1],[100,200,300],200,raggedParentIds([1,1,1]))) AS b8,
      LEEWAY_LIST_BY_TAG_EQUAL(['x1','x2','z1'],[2,0,1],[100,200,300],300,raggedParentIds([1,1,1])) = ['z1'] AS b9,
      -- Fixture C: array + aliasing, membership-card ([2,1]) decoupled from value-length ([3,1])
      raggedParentIds([2,1]) = [1,1,2] AS c1,
      LEEWAY_LIST_BY_TAG_EQUAL(['p1','p2','p3','q1'],[3,1],[10,11,20],11,raggedParentIds([2,1])) = ['p1','p2','p3'] AS c2,
      LEEWAY_LIST_BY_TAG_EQUAL(['p1','p2','p3','q1'],[3,1],[10,11,20],20,raggedParentIds([2,1])) = ['q1'] AS c3,
      -- Fixture D: single-attribute / zero-membership edges
      raggedParentIds([1]) = [1] AS d1,
      raggedParentIds([3]) = [1,1,1] AS d2,
      empty(raggedParentIds([0])) AS d3,
