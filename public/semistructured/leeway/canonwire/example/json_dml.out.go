...
func CreateSchemaJson() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		...
		/* 027 */ arrow.Field{Name: "tv:emptyObject:lmv:lmv:y:124:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 028 */ arrow.Field{Name: "tv:emptyObject:mvhp:mvhp:y:4:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 029 */ arrow.Field{Name: "tv:emptyObject:lmvcard:lmvcard:u64:4E:::0::", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
		/* 030 */ arrow.Field{Name: "tv:emptyArray:lmv:lmv:y:124:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 031 */ arrow.Field{Name: "tv:emptyArray:mvhp:mvhp:y:4:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.BinaryType{})},
		/* 032 */ arrow.Field{Name: "tv:emptyArray:lmvcard:lmvcard:u64:4E:::0::", Nullable: false, Type: arrow.ListOfNonNullable(arrow.PrimitiveTypes.Uint64)},
	}, nil)
	return
}
...
type InEntityJson struct {
	...
	section01Inst         *InEntityJsonSectionEmptyArray
	section02Inst         *InEntityJsonSectionEmptyObject
	section03Inst         *InEntityJsonSectionFloat64
	section04Inst         *InEntityJsonSectionInt64
	section05Inst         *InEntityJsonSectionNull
	section06Inst         *InEntityJsonSectionString
	section07Inst         *InEntityJsonSectionSymbol
	section08Inst         *InEntityJsonSectionUndefined
	activeSections        *[9]bool
...
func (inst *InEntityJson) initSections(builder *array.RecordBuilder) {
	...
	inst.section01Inst = NewInEntityJsonSectionEmptyArray(builder, inst)
	inst.section02Inst = NewInEntityJsonSectionEmptyObject(builder, inst)
	inst.section03Inst = NewInEntityJsonSectionFloat64(builder, inst)
	inst.section04Inst = NewInEntityJsonSectionInt64(builder, inst)
	inst.section05Inst = NewInEntityJsonSectionNull(builder, inst)
	inst.section06Inst = NewInEntityJsonSectionString(builder, inst)
	inst.section07Inst = NewInEntityJsonSectionSymbol(builder, inst)
...
func (inst *InEntityJson) GetSectionEmptyArray() *InEntityJsonSectionEmptyArray {
	return inst.section01Inst
}
func (inst *InEntityJson) GetSectionEmptyObject() *InEntityJsonSectionEmptyObject {
...
func (inst *InEntityJson) validateEntity() {
	...
	}
	{
		...
		switch state {
		case runtime.EntityStateInAttribute:
			inst.AppendError(eb.Build().Str("section", "emptyArray").Stringer("state", state).Errorf("wrong state: Check that .BeginAttribute() is followed by .EndAttribute()"))
			break
		}
	}
	{
		...
		switch state {
		case runtime.EntityStateInAttribute:
			inst.AppendError(eb.Build().Str("section", "emptyObject").Stringer("state", state).Errorf("wrong state: Check that .BeginAttribute() is followed by .EndAttribute()"))
			break
		}
	}
	{
...
type InEntityJsonSectionEmptyArray struct {
	inAttr         *InEntityJsonSectionEmptyArrayInAttr
	parent         *InEntityJson
	errs           []error
	attributeCount int
	state          runtime.EntityStateE
...
func NewInEntityJsonSectionEmptyArray(builder *array.RecordBuilder, parent *InEntityJson) (inst *InEntityJsonSectionEmptyArray) {
	inst = &InEntityJsonSectionEmptyArray{}
	inAttr := NewInEntityJsonSectionEmptyArrayInAttr(builder, inst)
	inst.errs = make([]error, 0, 8)
	inst.state = runtime.EntityStateInitial
	inst.inAttr = inAttr
	inst.parent = parent
...
func (inst *InEntityJsonSectionEmptyArray) endAttribute() {
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInSection
		break
...
func (inst *InEntityJsonSectionEmptyArray) BeginAttribute() *InEntityJsonSectionEmptyArrayInAttr {
	switch inst.state {
	case runtime.EntityStateInSection:
		inst.state = runtime.EntityStateInAttribute
		break
...
type InEntityJsonSectionEmptyArrayAttr struct {
}

func (inst *InEntityJsonSectionEmptyArray) Add(attr InEntityJsonSectionEmptyArrayAttr) *InEntityJsonSectionEmptyArrayInAttr {
	a := inst.BeginAttribute()
	return a
}
func (inst *InEntityJsonSectionEmptyArray) CheckErrors() (err error) {
	err = eh.CheckErrors(slices.Concat(inst.errs, inst.inAttr.errs))
	return
}
func (inst *InEntityJsonSectionEmptyArray) EndSection() *InEntityJson {
	switch inst.state {
	case runtime.EntityStateInSection:
		inst.state = runtime.EntityStateInitial
		break
...
func (inst *InEntityJsonSectionEmptyArray) beginSection() {
	inst.state = runtime.EntityStateInSection
	inst.attributeCount = 0
	inst.inAttr.beginAttribute()
}

func (inst *InEntityJsonSectionEmptyArray) resetSection() {
	inst.clearErrors()
	inst.inAttr.clearErrors()
	inst.attributeCount = 0
	inst.state = runtime.EntityStateInitial
...
func (inst *InEntityJsonSectionEmptyArray) AppendError(err error) {
	inst.errs = eh.AppendError(inst.errs, err)
}
func (inst *InEntityJsonSectionEmptyArray) clearErrors() {
	inst.errs = eh.ClearErrors(inst.errs)
}

type InEntityJsonSectionEmptyArrayInAttr struct {
	parent                           *InEntityJsonSectionEmptyArray
...
func NewInEntityJsonSectionEmptyArrayInAttr(builder *array.RecordBuilder, parent *InEntityJsonSectionEmptyArray) (inst *InEntityJsonSectionEmptyArrayInAttr) {
	inst = &InEntityJsonSectionEmptyArrayInAttr{}
	inst.errs = make([]error, 0, 8)
	inst.state = runtime.EntityStateInitial
	inst.parent = parent
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) beginAttribute() {
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) AddMembershipMixedLowCardVerbatim(lmv30 []byte, mvhp31 []byte) *InEntityJsonSectionEmptyArrayInAttr {
	if inst.state != runtime.EntityStateInAttribute {
		inst.AppendError(runtime.ErrInvalidStateTransition)
		return inst
	}
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) AddMembershipMixedLowCardVerbatimP(lmv30 []byte, mvhp31 []byte) {
	if inst.state != runtime.EntityStateInAttribute {
		inst.AppendError(runtime.ErrInvalidStateTransition)
		return
	}
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) handleMembershipSupportColumns() {
	var l int
	var _ = l
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) handleNonScalarSupportColumns() {
	var l int
	var _ = l
}
func (inst *InEntityJsonSectionEmptyArrayInAttr) applyAmbientMemberships() {
}
func (inst *InEntityJsonSectionEmptyArrayInAttr) completeAttribute() {
	inst.handleMembershipSupportColumns()
	inst.handleNonScalarSupportColumns()
}
func (inst *InEntityJsonSectionEmptyArrayInAttr) EndSection() *InEntityJson {
	inst.applyAmbientMemberships()
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInitial
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) EndAttribute() *InEntityJsonSectionEmptyArray {
	inst.applyAmbientMemberships()
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInSection
...
func (inst *InEntityJsonSectionEmptyArrayInAttr) EndAttributeP() {
	inst.EndAttribute()
}

func (inst *InEntityJsonSectionEmptyArrayInAttr) AppendError(err error) {
	inst.errs = eh.AppendError(inst.errs, err)
}
func (inst *InEntityJsonSectionEmptyArrayInAttr) clearErrors() {
	inst.errs = eh.ClearErrors(inst.errs)
}

type InEntityJsonSectionEmptyObject struct {
	inAttr         *InEntityJsonSectionEmptyObjectInAttr
	parent         *InEntityJson
	errs           []error
	attributeCount int
	state          runtime.EntityStateE
...
func NewInEntityJsonSectionEmptyObject(builder *array.RecordBuilder, parent *InEntityJson) (inst *InEntityJsonSectionEmptyObject) {
	inst = &InEntityJsonSectionEmptyObject{}
	inAttr := NewInEntityJsonSectionEmptyObjectInAttr(builder, inst)
	inst.errs = make([]error, 0, 8)
	inst.state = runtime.EntityStateInitial
	inst.inAttr = inAttr
	inst.parent = parent
...
func (inst *InEntityJsonSectionEmptyObject) endAttribute() {
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInSection
		break
...
func (inst *InEntityJsonSectionEmptyObject) BeginAttribute() *InEntityJsonSectionEmptyObjectInAttr {
	switch inst.state {
	case runtime.EntityStateInSection:
		inst.state = runtime.EntityStateInAttribute
		break
...
type InEntityJsonSectionEmptyObjectAttr struct {
}

func (inst *InEntityJsonSectionEmptyObject) Add(attr InEntityJsonSectionEmptyObjectAttr) *InEntityJsonSectionEmptyObjectInAttr {
	a := inst.BeginAttribute()
	return a
}
func (inst *InEntityJsonSectionEmptyObject) CheckErrors() (err error) {
	err = eh.CheckErrors(slices.Concat(inst.errs, inst.inAttr.errs))
	return
}
func (inst *InEntityJsonSectionEmptyObject) EndSection() *InEntityJson {
	switch inst.state {
	case runtime.EntityStateInSection:
		inst.state = runtime.EntityStateInitial
		break
...
func (inst *InEntityJsonSectionEmptyObject) beginSection() {
	inst.state = runtime.EntityStateInSection
	inst.attributeCount = 0
	inst.inAttr.beginAttribute()
}

func (inst *InEntityJsonSectionEmptyObject) resetSection() {
	inst.clearErrors()
	inst.inAttr.clearErrors()
	inst.attributeCount = 0
	inst.state = runtime.EntityStateInitial
...
func (inst *InEntityJsonSectionEmptyObject) AppendError(err error) {
	inst.errs = eh.AppendError(inst.errs, err)
}
func (inst *InEntityJsonSectionEmptyObject) clearErrors() {
	inst.errs = eh.ClearErrors(inst.errs)
}

type InEntityJsonSectionEmptyObjectInAttr struct {
	parent                           *InEntityJsonSectionEmptyObject
...
func NewInEntityJsonSectionEmptyObjectInAttr(builder *array.RecordBuilder, parent *InEntityJsonSectionEmptyObject) (inst *InEntityJsonSectionEmptyObjectInAttr) {
	inst = &InEntityJsonSectionEmptyObjectInAttr{}
	inst.errs = make([]error, 0, 8)
	inst.state = runtime.EntityStateInitial
	inst.parent = parent
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) beginAttribute() {
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) AddMembershipMixedLowCardVerbatim(lmv27 []byte, mvhp28 []byte) *InEntityJsonSectionEmptyObjectInAttr {
	if inst.state != runtime.EntityStateInAttribute {
		inst.AppendError(runtime.ErrInvalidStateTransition)
		return inst
	}
	inst.membershipFieldBuilder027.Append(lmv27)
	inst.membershipFieldBuilder028.Append(mvhp28)
	inst.membershipContainerLength027++
	inst.membershipContainerLength028++
	return inst
}
func (inst *InEntityJsonSectionEmptyObjectInAttr) AddMembershipMixedLowCardVerbatimP(lmv27 []byte, mvhp28 []byte) {
	if inst.state != runtime.EntityStateInAttribute {
		inst.AppendError(runtime.ErrInvalidStateTransition)
		return
	}
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) handleMembershipSupportColumns() {
	var l int
	var _ = l
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) handleNonScalarSupportColumns() {
	var l int
	var _ = l
}
func (inst *InEntityJsonSectionEmptyObjectInAttr) applyAmbientMemberships() {
}
func (inst *InEntityJsonSectionEmptyObjectInAttr) completeAttribute() {
	inst.handleMembershipSupportColumns()
	inst.handleNonScalarSupportColumns()
}
func (inst *InEntityJsonSectionEmptyObjectInAttr) EndSection() *InEntityJson {
	inst.applyAmbientMemberships()
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInitial
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) EndAttribute() *InEntityJsonSectionEmptyObject {
	inst.applyAmbientMemberships()
	switch inst.state {
	case runtime.EntityStateInAttribute:
		inst.state = runtime.EntityStateInSection
...
func (inst *InEntityJsonSectionEmptyObjectInAttr) EndAttributeP() {
	inst.EndAttribute()
}

func (inst *InEntityJsonSectionEmptyObjectInAttr) AppendError(err error) {
	inst.errs = eh.AppendError(inst.errs, err)
}
func (inst *InEntityJsonSectionEmptyObjectInAttr) clearErrors() {
	inst.errs = eh.ClearErrors(inst.errs)
}
