...
func createRecordBuilder() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		/* 000 */ arrow.Field{Name: "id:key:u64:47::0:", Nullable: false, Type: arrow.PrimitiveTypes.Uint64},
		/* 001 */ arrow.Field{Name: "tv:symbol:value:val:s:124:::0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
