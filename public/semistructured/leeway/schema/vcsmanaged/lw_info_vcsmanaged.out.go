...
func createRecordBuilder() (schema *arrow.Schema) {
	schema = arrow.NewSchema([]arrow.Field{
		/* 000 */ arrow.Field{Name: "id:key:u64:2k:0:0:", Nullable: false, Type: arrow.PrimitiveTypes.Uint64},
		/* 001 */ arrow.Field{Name: "tv:symbol:value:val:s:m:0:0:0::", Nullable: false, Type: arrow.ListOfNonNullable(&arrow.StringType{})},
...
func (inst *InEntity) appendPlainValues() {
	inst.scalarFieldBuilder000.Append(inst.plainKey0)
}
func (inst *InEntity) resetPlainValues() {
	inst.plainKey0 = uint64(0)
}
...
func (inst *InEntitySymbol) BeginAttribute(value1 string) *InEntitySymbolInAttr {
	switch inst.state {
	case runtime.EntityStateInSection:
		inst.state = runtime.EntityStateInAttribute
		break
