...
func TestN2GeneratedSuffix(t *testing.T) {
	dir := fixture(t, map[string]string{
		"public/a/plain.go":      "package a\n",
		"public/a/wrong_name.go": "// Code generated by some tool. DO NOT EDIT.\n\npackage a\n",
		"public/a/right.out.go":  "// Code generated by some tool. DO NOT EDIT.\n\npackage a\n",
		"public/a/right.gen.go":  "// Code generated by some tool. DO NOT EDIT.\n\npackage a\n",
	})
	f, err := CheckE(Config{Dir: dir})
	require.NoError(t, err)
	assert.Equal(t, []string{"generated-suffix:public/a/wrong_name.go"}, strs(f))
}

// Go's test-discovery mechanics require the literal _test.go suffix, so a
// generated _test.go file structurally cannot also satisfy N2/N3 — this is
// exempt on principle, not because any specific file needs an excuse.
func TestN2ExemptsGeneratedTestFiles(t *testing.T) {
	dir := fixture(t, map[string]string{
		"public/a/wrong_name_test.go": "// Code generated by some tool. DO NOT EDIT.\n\npackage a\n",
	})
	f, err := CheckE(Config{Dir: dir})
	require.NoError(t, err)
...
// The header is only looked for within the first few lines, mirroring
// scripts/ci/lint.sh's gofmt step so a file's generated-ness reads the same
// way everywhere. A banner past that window is not judged either way.
func TestN2OnlyLooksAtLeadingLines(t *testing.T) {
	dir := fixture(t, map[string]string{
		"public/a/late_banner.go": "// 1\n// 2\n// 3\n// 4\n// 5\n// Code generated by some tool. DO NOT EDIT.\n\npackage a\n",
	})
	f, err := CheckE(Config{Dir: dir})
	require.NoError(t, err)
	assert.Empty(t, strs(f))
...
func TestFindingStringIsTheBaselineFormat(t *testing.T) {
	...
	assert.Equal(t, "generated-suffix:a/b.go", Finding{Rule: RuleN2, Path: "a/b.go"}.String())
