...
var PackageProps = packageprops.Props{
	...
	CapsDirect:       packageprops.Caps(packageprops.CapabilityFiles, packageprops.CapabilityNetwork, packageprops.CapabilityRuntime, packageprops.CapabilityModifySystemState),
...
func init() {
	packageprops.Register("github.com/stergiotis/boxer/public/gov/licensegate", PackageProps)
}
